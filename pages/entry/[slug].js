...
function SectionRenderer({ section }) {
  switch (section.type) {
    ...
    case 'cta':
      return (
        <a href={section.href} target="_blank" rel="noopener noreferrer" style={{
...
export default function EntryPostPage({ meta, postData, related, internalLinks, similarPosts }) {
  ...
  return (
    <Layout title={meta.title} description={meta.description}>
      ...
      <PageTracker slug={meta.tistorySlug || meta.slug} />
      ...
      {related && related.length > 0 && (
        <section style={{ maxWidth: 720, margin: '56px auto 0' }}>
          <div style={{ borderTop: '1px solid var(--border-color, #eee)', paddingTop: 32 }}>
            <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 20, opacity: 0.7 }}>관련 포스팅</h3>
      ...
      {internalLinks && internalLinks.sameWork && internalLinks.sameWork.length > 0 && (
        <section style={{ maxWidth: 720, margin: '40px auto 0' }}>
          <div style={{ borderTop: '1px solid var(--border-color, #eee)', paddingTop: 24 }}>
            <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 16, opacity: 0.7 }}>같은 작품의 다른 글</h3>
      ...
      {similarPosts && similarPosts.length > 0 && (
        <section style={{ maxWidth: 720, margin: '40px auto 0' }}>
          <div style={{ borderTop: '1px solid var(--border-color, #eee)', paddingTop: 32 }}>
            <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 20, opacity: 0.7 }}>이 작품이 좋았다면</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 16 }}>
