const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post319_thumb.svg',
      alt: '넷플릭스 시청가능 원더랜드 뜻 의미 박보검 주연 해외 평점과 후기반응은?',
      caption: '넷플릭스 시청가능 원더랜드 뜻 의미 박보검 주연 해외 평점과 후기반응은?'
    },
    { type: 'toc' },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'body',
      html: '<p><b>영화 원더랜드 로튼토마토 평점입니다.</b></p>'
    },
    {
      type: 'body',
      html: '<p><b>평론가 평점은 확인되지 않으며, 관람객 평점은 57%로 저조한 성적</b>을 기록하고 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>현재 넷플릭스에서 시청가능하지만, 개봉 당시 박보검의 인기에 힘입어 한국에서는 흥행을 하였지만, 영화 전체적으로는 좋은 작품은 아닌것 같습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>원더랜드 해외 후기 반응을 통해 좀 더 자세히 알아보겠습니다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>영화 원더랜드 해외 후기반응 확인해보겠습니다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p><b>Cheri Y</b> (3.0 stars): 연기력은 정말 뛰어났음. 그 덕분에 2점짜리 영화를 3점으로 올림. 너무 많은 주제를 다루려고 하다 보니 일관된 스토리가 부족했음. 차라리 TV 시리즈로 만들거나, 세 개의 스토리 중 하나나 두 개에만 집중했으면 좋았을 거임. 비주얼은 멋있지만 스토리에 큰 도움을 주지 않는 장면도 많았음. 기대가 컸던 만큼 실망도 컸던 영화였음.</p>'
    },
    {
      type: 'body',
      html: '<p><b>Guillermo P</b> (4.5 stars): &quot;원더랜드&quot;는 인공지능(AI)의 미래에 대해 다루지만 흔한 디스토피아적 이야기로 빠지지 않음. 오히려 AI가 일상의 일부로 자리잡은 미래를 그렸음. 기술을 만든 이들도 악당이 아닌 평범한 사람들로 묘사됨. AI에 관심이 있는 사람이라면 4.5점짜리 영화지만, 그렇지 않다면 조금 낮게 느껴질 수 있을 듯함. 개인적으로는 매우 재밌었음.</p>'
    },
    {
      type: 'body',
