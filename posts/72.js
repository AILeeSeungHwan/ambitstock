const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: '<p>2025년 9월, 이탈리아와 프랑스 합작 드라마/로맨스 영화 <b>파르테노페(Parthenope)</b>가 드디어 관객을 만납니다. <b>파올로 소렌티노</b> 감독의 신작으로, 아름다운 나폴리를 배경으로 펼쳐지는 미스터리한 여성 ‘파르테노페’의 삶을 담아낸 작품입니다.</p><p><b>셀레스테 달라 포르타</b>, <b>게리 올드만</b>, <b>스테파노 산드렐리</b>, <b>실비오 올란도</b>가 출연하여 화제를 모으고 있습니다.</p><p>이번 포스팅에서는 <b>파르테노페 해외 평론가 반응</b>과 <b>실제 관객 후기</b>를 함께 정리했습니다.</p><p>작품의 기본 정보와 평단의 평가를 살펴보시고, 관람 전 참고하시길 바랍니다.</p>'
    },
    {
      type: 'image',
      src: '/images/post72_thumb.svg',
      alt: '영화 파르테노페 관람평 후기 | 파올로 소렌티노 신작 해외 평론가·관객 반응',
      caption: '영화 파르테노페 관람평 후기 | 파올로 소렌티노 신작 해외 평론가·관객 반응'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<ul style=&quot;list-style-type: disc;&quot;> <li><b>Carlos Bonfil (La Jornada)</b> — “소렌티노가 과감한 아이코노클라스트로 자신을 다시 세운 작품.”</li> <li><b>Sean P. Means (The Movie Cricket)</b> — “여배우의 내적 깊이는 훌륭했지만, 전체적으로 더 의미 있는 무언가로 묶이지 못했다” (2.5/4).</li> </ul>'
    },
    {
      type: 'body',
      html: '<p>평론가들은 <b>영상미와 주연의 매력</b>에는 긍정적이었으나, <b>서사적 빈약함과 남성적 시선</b>에 대한 비판도 강했습니다.</p>'
    },
    {
      type: 'h2',
      id: 'section3',
      text: '영화 파르테노페 관객 관람평',
    ...
    {
      type: 'body',
      html: '<p>관객 반응은 <b>영상미와 분위기</b>에 매료되었다는 호평과, <b>스토리의 공허함</b>에 실망했다는 혹평이 팽팽히 맞섰습니다.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
