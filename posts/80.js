const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: '<p>가을의 한가운데, 10월은 영화 팬들에게 늘 풍성한 계절입니다. 긴 연휴가 끝나고 선선한 바람이 불어오는 시기, 극장가는 재개봉 명작과 화제의 신작들로 가득 차 관객들을 불러 모읍니다.</p><p>2025년 10월 역시 예외가 아니에요. <b>헐리우드 블록버스터부터 한국형 드라마, 가족 애니메이션, 그리고 오랫동안 기다려온 재개봉 작품</b>까지 장르와 규모를 가리지 않고 고르게 포진되어 있습니다.</p><p><figure class=&quot;imageblock widthContent&quot; data-origin-height=&quot;690&quot; data-origin-width=&quot;692&quot;><span data-alt=&quot;개봉예정작 영화 2025년 10월&quot; data-phocus=&quot;https://blog.kakaocdn.net/dna/m3dk8/btsQB1OkE51/AAAAAAAAAAAAAAAAAAAAAK-mTSGLVjFdB1hDRsLBJ6seU9CdicEKhM3Gh6csNqnq/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=DcMGXNKqQH7nLohmJCOqnUmf3fk%3D&quot; data-url=&quot;https://blog.kakaocdn.net/dna/m3dk8/btsQB1OkE51/AAAAAAAAAAAAAAAAAAAAAK-mTSGLVjFdB1hDRsLBJ6seU9CdicEKhM3Gh6csNqnq/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=DcMGXNKqQH7nLohmJCOqnUmf3fk%3D&quot;></span><figcaption>개봉예정작 영화 2025년 10월</figcaption> </figure> </p><p>이번 달 라인업을 보면 두 가지 특징이 두드러집니다.</p><p>첫째, <b>재개봉 명작</b>들이 눈에 띈다는 점입니다. 오랜 세월이 지나도 빛을 잃지 않는 고전들을 대형 스크린에서 다시 만날 수 있는 기회죠.</p><p>둘째, <b>새로운 도전과 신작</b>입니다. 감성적인 휴먼 드라마, 강렬한 액션 스릴러, 그리고 전 연령층이 즐길 수 있는 애니메이션까지 고르게 포진해 있어 관객 선택지가 한층 넓어졌습니다.</p><p>영화를 고를 때 단순히 “재밌을까?”라는 기대감 외에도, 개봉일정을 미리 확인하고 줄거리와 관점포인트를 체크하며 <b>언제, 누구와, 어떤 작품을 볼지 계획</b>하는 것도 극장을 즐기는 또 다른 재미입니다. 이번 포스팅에서는 <b>2025년 10월 개봉예정작 영화 10편</b>을 선별해 줄거리, 출연진, 그리고 관람 포인트를 알기 쉽게 정리했습니다. 리스트를 살펴보면서 10월 당신의 극장 나들이 계획을 세워보세요.</p><p>1</p>'
    },
    {
      type: 'image',
      src: '/images/post80_thumb.svg',
      alt: '개봉예정작 영화 2025년 10월 | 줄거리·예매율·관람포인트 총정리',
      caption: '개봉예정작 영화 2025년 10월 | 줄거리·예매율·관람포인트 총정리'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p>판도라로 돌아온 제이크와 네이티리. 가족이 된 그들이 새로운 위협을 피해 바다 부족과 만나며 ‘바다의 길’을 배우는 여정을 그린다.</p>'
    },
    {
      type: 'body',
      html: '<h3>관람 포인트</h3>'
    ...
    {
      type: 'body',
      html: '<p>대화면·고프레임·3D로 최적화된 비주얼 체험. 바다 생태·생존 서사 확장.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><a href=&quot;https://search.naver.com/search.naver?query=아바타+물의+길+예매&quot; title=&quot;예매/정보&quot;><button class=&quot;btn-hover color-8&quot;>예매/정보 보기</button></a></p>'
    },
    {
      type: 'h2',
      id: 'section2',
    ...
    {
      type: 'body',
      html: '<p>사람 곁에서 살도록 만들어진 헬퍼 로봇과 외로운 청년이 서로의 결핍을 채우며 ‘관계’의 의미를 배워가는 휴먼 로맨스.</p>'
    },
    {
      type: 'body',
      html: '<h3>관람 포인트</h3>'
    ...
    {
      type: 'body',
      html: '<p>동명 스테디셀러 뮤지컬 감성 계승, OST 기대치 높음. ‘인간다움’에 대한 잔잔한 질문.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><a href=&quot;https://search.naver.com/search.naver?query=어쩌면+해피엔딩+영화&quot; title=&quot;예매/정보&quot;><button class=&quot;btn-hover color-8&quot;>예매/정보 보기</button></a></p>'
    },
    {
      type: 'h2',
      id: 'section3',
    ...
    {
      type: 'body',
      html: '<p>피치 못할 사건에 휘말린 인물들이 ‘보스’ 자리와 조직의 판도를 둘러싸고 벌이는 코믹 범죄 활극.</p>'
    },
    {
      type: 'body',
      html: '<h3>관람 포인트</h3>'
    ...
    {
      type: 'body',
      html: '<p>명확한 캐릭터 플레이, 추석 연휴 이후 가벼운 웃음 찾는 관객층 공략.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><a href=&quot;https://search.naver.com/search.naver?query=보스+영화+2025&quot; title=&quot;예매/정보&quot;><button class=&quot;btn-hover color-8&quot;>예매/정보 보기</button></a></p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
    ...
    {
      type: 'body',
      html: '<p>개비와 귀여운 냥이 친구들이 장난감 하우스에서 펼치는 신나는 대모험. TV 시리즈의 인기 에피소드를 스크린 감성으로 확장.</p>'
    },
    {
      type: 'body',
      html: '<h3>예매율</h3>'
    ...
    {
      type: 'body',
      html: '<p>유아·초등 동반 가족 관객 필참. 굿즈/포토카드 이벤트 체크.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><a href=&quot;https://search.naver.com/search.naver?query=개비의+매직하우스+극장판+예매&quot; title=&quot;예매/정보&quot;><button class=&quot;btn-hover color-8&quot;>예매/정보 보기</button></a></p>'
    },
    {
      type: 'h2',
      id: 'section5',
      text: '배달의 영웅: 캐리와 슈퍼콜라 2',
    ...
    {
      type: 'body',
      html: '<p>도시를 위협하는 사건 속, 캐리와 팀이 새로운 아이템과 팀워크로 미션을 해결한다.</p>'
    },
    {
      type: 'body',
      html: '<h3>관람 포인트</h3>'
    ...
    {
      type: 'body',
      html: '<p>시리즈 팬층 고정 수요. 밝은 색감·경쾌한 음악으로 어린이 취향 저격.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><a href=&quot;https://search.naver.com/search.naver?query=배달의+영웅+캐리와+슈퍼콩란+2&quot; title=&quot;예매/정보&quot;><button class=&quot;btn-hover color-8&quot;>예매/정보 보기</button></a></p>'
    },
    {
      type: 'h2',
      id: 'section6',
    ...
    {
      type: 'body',
      html: '<p>마이클 코를레오네의 현재와 비토의 과거가 교차하는 서사. 가문의 명과 암, 권력의 대물림을 압도적 연출로 보여준다.</p>'
    },
    {
      type: 'body',
      html: '<h3>관람 포인트</h3>'
    ...
    {
      type: 'body',
      html: '<p>클래식 복원 상영 기대. 대사·음악·미장센을 큰 스크린에서 재확인.</p>'
    },
    {
      type: 'body',
      html: '<p><a href=&quot;https://search.naver.com/search.naver?query=대부+2+재개봉+예매&quot; title=&quot;예매/정보&quot;><button class=&quot;btn-hover color-8&quot;>예매/정보 보기</button></a></p>'
    },
    {
      type: 'h2',
      id: 'section7',
    ...
    {
      type: 'body',
      html: '<p>비밀스러운 ‘무기’ 프로젝트에 얽힌 이들이 서로의 목적을 위해 움직이며 맞부딪히는 미스터리 액션 스릴러.</p>'
    },
    {
      type: 'body',
      html: '<h3>관람 포인트</h3>'
    ...
    {
      type: 'body',
      html: '<p>장르적 긴장·추격·반전 구성이 핵심. 액션 세트피스 기대.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><a href=&quot;https://search.naver.com/search.naver?query=웨폰+영화+2025&quot; title=&quot;예매/정보&quot;><button class=&quot;btn-hover color-8&quot;>예매/정보 보기</button></a></p>'
    },
    {
      type: 'h2',
      id: 'section8',
    ...
    {
      type: 'body',
      html: '<p>문제 풀이에선 천재, 삶에서는 아직 미숙한 ‘형주’가 대회와 입시, 우정과 성장의 갈림길에서 선택을 배우는 청춘 드라마.</p>'
    },
    {
      type: 'body',
      html: '<h3>관람 포인트</h3>'
    ...
    {
      type: 'body',
      html: '<p>수학 소재의 성장 서사. 청소년 관객 공감 포인트 다수.</p>'
    },
    {
      type: 'body',
      html: '<p><a href=&quot;https://search.naver.com/search.naver?query=수학영재+형주+영화&quot; title=&quot;예매/정보&quot;><button class=&quot;btn-hover color-8&quot;>예매/정보 보기</button></a></p>'
    },
    {
      type: 'h2',
      id: 'section9',
    ...
    {
      type: 'body',
      html: '<p>‘고죠 사토루’와 ‘게토 스구루’의 과거를 중심으로 세계관의 기원을 다시 짚는 극장판 구성. 우정과 신념의 균열이 비극으로 번져간다.</p>'
    },
    {
      type: 'body',
      html: '<h3>관람 포인트</h3>'
    ...
    {
      type: 'body',
      html: '<p>TV 시리즈 명장면 재구성 + 신규 컷 기대. 세계관 이해에 도움.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><a href=&quot;https://search.naver.com/search.naver?query=주술회전+회옥+옥절+극장판+예매&quot; title=&quot;예매/정보&quot;><button class=&quot;btn-hover color-8&quot;>예매/정보 보기</button></a></p>'
    },
    {
      type: 'h2',
      id: 'section10',
    ...
    {
      type: 'body',
      html: '<p>치열했던 역사 속 기록과 증언을 바탕으로, 나라를 지켜낸 사람들의 선택을 되짚는 다큐멘터리/전쟁 드라마 성격의 작품.</p>'
    },
    {
      type: 'body',
      html: '<h3>관람 포인트</h3>'
    ...
    {
      type: 'body',
      html: '<p>역사적 사실·아카이브의 무게감. 시사 성격의 GV 여부 체크.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><a href=&quot;https://search.naver.com/search.naver?query=피로+지켜낸+대한민국+영화&quot; title=&quot;예매/정보&quot;><button class=&quot;btn-hover color-8&quot;>예매/정보 보기</button></a></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><b>10.16 이후 개봉 영화들의 정보는 다음 포스팅에서 이어집니다!</b></p>'
    },
    {
      type: 'h2',
      id: 'section11',
