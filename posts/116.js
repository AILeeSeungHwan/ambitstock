const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: '<p>개봉예정영화 2025년 1월 추천 순위 총정리 TOP10</p>'
    },
    {
      type: 'image',
      src: '/images/post116_thumb.svg',
      alt: '개봉예정영화 2025년 1월 추천 순위 총정리 TOP10',
      caption: '개봉예정영화 2025년 1월 추천 순위 총정리 TOP10'
    },
    { type: 'toc' },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section1',
      text: '개봉예정영화 2025년 1월 추천 순위 총정리',
    ...
    {
      type: 'body',
      html: '<p>이번 포스팅을 통해 2025년 1월에 개봉하는 모든 영화의 해외 평론가 후기 반응과 평점을 모두 확인해 보실 수 있습니다.<span> </span></p>'
    },
    {
      type: 'body',
      html: '<p><b><span style=&quot;background-color: #9feec3;&quot;>포스팅 하단에 1월 기대되는 한국 영화 포스팅 첨부하였으니 한국 영화를 찾으시는 분은 포스팅 하단으로 이동</span></b>하시길 바랍니다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>모든 영화 중 특히 해외 평점이 좋은 작품들로만 선별하였고, 순서는 개봉일 순으로 정렬</b></span>하였습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<h3>수퍼 소닉 3 로튼 토마토 평점</h3>'
    },
    {
      type: 'body',
      html: '<p>평론가 평점 86%, 관람객 평점 98%</p>'
    },
    {
      type: 'body',
      html: '<h3>평론가 한줄평</h3>'
    ...
    {
      type: 'body',
      html: '<blockquote><b><span style=&quot;font-family: \'Noto Serif KR\';&quot;>톰 크루즈 대신 <br>말하는 파란색 고슴도치가 등장하는 <br>미션: 임파서블</br></br></span></b></blockquote>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<h3>총을 든 스님 로튼 토마토 평점</h3>'
    },
    {
      type: 'body',
      html: '<p><b><span style=&quot;background-color: #9feec3;&quot;>평론가 평점 94%, 관람객 평점 100%</span></b></p>'
    },
    {
      type: 'body',
      html: '<p><figure class=&quot;imageblock widthContent&quot; data-origin-height=&quot;644&quot; data-origin-width=&quot;1864&quot;><span data-alt=&quot;총을 든 스님 로튼 토마토 평점&quot; data-phocus=&quot;https://blog.kakaocdn.net/dna/blL0jL/btsLz7zxWId/AAAAAAAAAAAAAAAAAAAAADk91AxhW7wysaUsN3kLwn-XKol_f_ON3L_2JboOB-nG/tfile.dat?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=72DtSk4VqfDACWk2sfA4x7WHBo4%3D&quot; data-url=&quot;https://blog.kakaocdn.net/dna/blL0jL/btsLz7zxWId/AAAAAAAAAAAAAAAAAAAAADk91AxhW7wysaUsN3kLwn-XKol_f_ON3L_2JboOB-nG/tfile.dat?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=72DtSk4VqfDACWk2sfA4x7WHBo4%3D&quot;></span><figcaption>총을 든 스님 로튼 토마토 평점</figcaption> </figure> </p>'
    },
    {
      type: 'body',
      html: '<h3>평론가 한줄평</h3>'
    ...
    {
      type: 'body',
      html: '<blockquote><span style=&quot;color: #781b33;&quot;><b><span style=&quot;font-family: \'Noto Serif KR\';&quot;>변화에 대한 반영과 <br/>인위적인 이데올로기가 <br/>어떻게 통치 시스템을 지탱하는지 <br/>잘 보여주는 영화 총을 든 스님</span></b></span></blockquote>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>2025년 1월 3일</p>'
    },
    {
      type: 'body',
      html: '<h3>월레스와 그로밋 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p>최첨단 발명품을 만든 월레스. 하지만 이 발명품이 제멋대로 작동하면서, 예상치 못한 범죄에 연루되게 된다. 결국, 똑똑한 개 그로밋이 주인을 구하기 위해 본격적으로 나서는데…</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<h3>피스 바이 피스 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p>“제 이야기를 레고로 만들면 대박이지 않아요?” 창조의 귀재, 현존하는 최고의 아티스트 ‘퍼렐 윌리엄스’. 제이 지, 켄드릭 라마, 저스틴 팀버레이크, 스눕 독 등 유명 아티스트들의 찬사를 받은 음악의 신. 그가 손대는 모든 것들이 예술로 변한다! 레고로 구현된 ‘퍼렐 윌리엄스’의 끝없는 상상력의 세계가 펼쳐진다!</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<h3>노스페라투 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p>오랜 시간, 통제할 수 없는 강력한 힘에 이끌려 악몽과 고통 속에서 살아온 ‘엘렌’. 남편 ‘토마스’가 중요한 부동산 계약을 위해 먼 ‘올록성’으로 떠난 이후, 엘렌은 점점 더 불안정해지고, 알 수 없는 말들을 반복하기 시작한다. “그가 오고 있어…”. 이상한 현상들이 연이어 일어나며, 마을을 감도는 불길한 그림자. 영원의 어둠 속에서 깨어난 올록 백작이 다가오고 있다…</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;>평점과 평론가 후기는 아래 포스팅에서 확인</p>'
    },
    {
      type: 'cta',
    ...
    {
      type: 'body',
      html: '<h3>리얼 페인 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<blockquote><span style=&quot;color: #781b33;&quot;><b><span style=&quot;font-family: \'Noto Serif KR\';&quot;>성격부터 취향, 외모까지 <br/>너무나 다른 두 사촌, <br/>그들의 여행은 과연 괜찮을까?</span> </b></span></blockquote>'
    },
    {
      type: 'body',
      html: '<p>\'데이비드\'(제시 아이젠버그)와 \'벤지\'(키에란 컬킨)는 사춘기 시절, 형제처럼 친근했던 관계였지만, 시간과 함께 각자의 삶에 치여 점차 멀어졌다.</p>'
    },
    {
      type: 'body',
      html: '<p>그러던 중, 돌아가신 할머니를 기리기 위해 오랜만에 만난 두 사람은 할머니의 고향인 폴란드를 찾아 투어를 떠나게 된다. 그런데 투어를 시작하면서, 그들의 극과 극 성격은 자연스럽게 충돌하고,</p>'
    },
    {
      type: 'body',
      html: '<p>예상치 못한 사건들이 이어지며, 둘 사이의 갈등은 더욱 깊어지기만 하는데...</p>'
    },
    {
      type: 'body',
      html: '<p><b>2025년 새해, 감동과 웃음이 넘치는 완벽한 로드 무비가 온다!</b></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>2025년 1월 말 예정</p>'
    },
    {
      type: 'body',
      html: '<h3>반지의 제왕: 로히림의 전쟁 줄거리</h3>'
    },
    {
      type: 'body',
    ...
    },
    {
      type: 'h2',
      id: 'section12',
      text: '2025년 넷플릭스 한국영화 개봉예정작 총정리',
      gradientStyle: 'linear-gradient(to right, #1a1a2e, #e94560)'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<h3>2025년 넷플릭스 한국영화 개봉예정작 총정리</h3>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>이상으로 2025년 1월 모든 영화에 대한 정리 포스팅 마칩니다.</p>'
    },
    {
      type: 'body',
      html: '<p>해당 포스팅을 바탕으로 기대하는 작품의 정보와 보고 싶은 작품을 찾으셨길 바랍니다.</p>'
    },
    {
      type: 'body',
      html: '<p>감사합니다.</p>'
