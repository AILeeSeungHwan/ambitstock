const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post389_thumb.svg',
      alt: '드라마 굿 파트너 시청률 폭발 인기몰이! 해외 반응 후기 평점을 알아보자 | 출연진 줄거리 등장인물관계도 재방송 총정리',
      caption: '드라마 굿 파트너 시청률 폭발 인기몰이! 해외 반응 후기 평점을 알아보자 | 출연진 줄거리 등장인물관계도 재방송 총정리'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p><b>방송 채널:</b> SBS</p>'
    },
    {
      type: 'body',
      html: '<p><b>방송 시간:</b> 매주 금, 토 밤 10시</p>'
    },
    {
      type: 'body',
      html: '<p><b>총 회차 몇 부작?:</b> 16부작 예정</p>'
    },
    {
      type: 'body',
      html: '<p><b>다시보기:</b> 웨이브, 넷플릭스, VIU 등을 통해 시청 가능</p>'
    },
    {
      type: 'body',
      html: '<p><b>시청률</b>: 1화 7.8% 시작, 2화 8.7%, <span style=&quot;background-color: #f3c000;&quot;><b>3화 10.5, 4화 13.7%</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>SBS 금토드라마 &quot;굿 파트너&quot;는 2024년 7월 12일에 첫 방송을 시작한 법정 오피스 드라마입니다.</p>'
    },
    {
      type: 'body',
      html: '<p>베테랑 이혼 변호사 차은경(장나라)과 신입 변호사 한유리(남지현)가 중심이 되어, 이혼 사건을 다루며 벌어지는 이야기를 배경으로 합니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><b>장나라, 남지현 주연, 김준한 피오 지승현 출연작! </b></p>'
    },
    {
      type: 'body',
      html: '<p>드라마 굿 파트너 등장인물과 인물관계도 알아보겠습니다. </p>'
    },
    {
      type: 'body',
