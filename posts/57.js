const post = {
  ...
  sections: [
    ...
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section1',
      text: '박스오피스 순위 (2025년 10월 11일 기준)',
    ...
    {
      type: 'body',
      html: '<p>CGV <b>골든에그지수 97%</b>, 롯데시네마 <b>9.4점</b>, 메가박스 <b>9.4점</b> 등 극장 3사에서 모두 <b>평점 9점대</b>를 기록하며 관람객 만족도도 매우 높습니다. 입소문을 타며 평일 예매율 1위를 꾸준히 유지 중입니다.</p>'
    },
    {
      type: 'h2',
      id: 'section3',
      text: '일본 애니 흥행 신기록 가능성',
    ...
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section4',
      text: '경쟁작 현황 — ‘보스’와 ‘어쩔수가없다’도 선전 중',
    ...
    {
      type: 'body',
      html: '<blockquote style=&quot;border-left: 4px solid #5a55ae; padding-left: 12px; margin: 10px 0;&quot;>“보스와 박찬욱 신작이 밀릴 만큼 몰입감이 강했다.” — 롯데시네마 리뷰</blockquote>'
    },
    {
      type: 'h2',
      id: 'section6',
      text: '역주행의 아이콘, 체인소 맨이 박스오피스도 지배했다',
      gradientStyle: 'linear-gradient(to right, #1a1a2e, #e94560)'
    },
    {
      type: 'body',
      html: '<p>최근 진격의거인부터 귀멸의칼날 등, 애니메이션 영화들의 극장판 성적이 눈에 띕니다. ‘<b>극장판 체인소 맨: 레제편</b>’ 또한 엄청난 <b>콘텐츠 파워</b>와 <b>팬덤 결집력</b>을 입증한 사례로 평가됩니다. 3주차에도 상위권을 유지하며 <b>200만 관객 돌파</b>가 눈앞이고, 국내 일본 애니 흥행 역사에 또 하나의 이정표를 세우고 있습니다.</p>'
    },
    {
      type: 'h2',
      id: 'section7',
