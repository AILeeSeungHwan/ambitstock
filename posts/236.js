const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '룸 넥스트 도어 해외 평론가 관람평', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: '알모도바르 연출에 대한 다양한 시각', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
