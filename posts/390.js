const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '마담 웹 로튼토마토 평점 — 역대급 혹평의 시작', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: '마담 웹 해외 평론가 반응 모음', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
