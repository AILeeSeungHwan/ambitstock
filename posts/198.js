const post = {
  ...
  sections: [
    {
      type: 'cta',
      href: '/movie-plot-현재상영작-위키드/',
      text: '현재상영작 영화 위키드 뜻 뮤지컬 소설 원작 줄거리 내용 <아리아나 그란데 출연작>'
    },
    {
      type: 'intro',
    ...
    {
      type: 'image',
      src: '/images/post198_thumb.svg',
      alt: '위키드 시사회 후기 관람평 | 해외 평론가 평가 반응 아리아나 그란데 &quot;완벽히 어울린다&quot; 현재상영작',
      caption: '위키드 시사회 후기 관람평 | 해외 평론가 평가 반응 아리아나 그란데 &quot;완벽히 어울린다&quot; 현재상영작'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<h4><b><span style=&quot;background-color: #f3c000;&quot;>2. 음악과 제작의 완성도</span></b></h4>'
    },
    {
      type: 'body',
      html: '<p>영화의 음악적 요소와 기술적인 완성도도 주목받았습니다. ‘위키드’의 무대판 팬들조차 영화의 새로운 해석에 감동받았다는 의견이 많았으며, &quot;모든 면에서 영화가 지향해야 할 완벽한 작품&quot;이라는 찬사를 받았습니다.</p>'
    },
    {
      type: 'h2',
      id: 'section3',
    ...
    {
      type: 'body',
      html: '<h4><br><span style=&quot;background-color: #f3c000;&quot;><b>2. 장르 한계</b></span></br></h4>'
    },
    {
      type: 'body',
      html: '<p><b>뮤지컬 장르에 익숙하지 않은 관객들에게는 영화가 여전히 매력적이지 않을 수 있다</b>는 의견도 있었습니다. 그러나 뮤지컬 팬들에게는 충분히 감동적인 경험을 제공한다는 점에서 대체로 긍정적 평가가 우세합니다.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section4',
      text: '위키드 로튼토마토 후기 관람평',
    ...
    {
      type: 'body',
      html: '<p>2024년 11월 18일, 평론가 닐 폰드(Neil Pond)는 위키드에 대해 긍정적인 리뷰를 남기며 다음과 같이 평가했습니다:</p>'
    },
    {
      type: 'body',
      html: '<blockquote><span style=&quot;color: #781b33;&quot;><b><span style=&quot;font-family: \'Noto Serif KR\';&quot;>&quot;시각적으로 놀라운, <br>환상적으로 꾸며진 노래와 춤의 향연&quot;</br></span></b></span></blockquote>'
    },
    {
      type: 'body',
