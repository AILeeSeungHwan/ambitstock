const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '레블리지 로튼토마토 평론가 후기 — 긍정 반응 모음', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: '극찬 일색 — 제레미 솔니어 연출력이 빛난 이유', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
    { type: 'body', html: "<p><figure><figcaption>넷플릭스 영화 레블리지 후기 결말리뷰</figcaption> </figure> </p>" },
    ...
    { type: 'h2', id: 'section3', text: '아쉬운 점도 있다 — 반복적 전개와 권력 비판의 한계', gradientStyle: 'linear-gradient(to right, #6a1b9a, #ab47bc)' },
    { type: 'body', html: "<p><figure><figcaption>넷플릭스 영화 레블리지 후기 결말리뷰</figcaption> </figure> </p>" },
