const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: '<p><b>미스터 플랑크톤에 대한 해외 시청자 리뷰를 모아 종합하여 하나의 리뷰를 만들었습니다.</b></p><p><b>이를 참고하여 해외 반응 함께 살펴보시길 바랍니다.</b></p>'
    },
    {
      type: 'image',
      src: '/images/post207_thumb.svg',
      alt: '미스터 플랑크톤 해외 시청자 후기 리뷰 평점! 넷플릭스 한국 드라마 추천 극찬일색 평가',
      caption: '미스터 플랑크톤 해외 시청자 후기 리뷰 평점! 넷플릭스 한국 드라마 추천 극찬일색 평가'
    },
    { type: 'toc' },
    ...
    },
    {
      type: 'h2',
      id: 'section2',
      text: 'K-Drama 리뷰: 감정적으로 몰입감 있는 여정, 뛰어난 연기 (평점: 9/10)',
    ...
    {
      type: 'body',
      html: '<p>두 사람은 해조(Hae Jo)의 생부를 찾기 위한 여정을 떠나며, 그 과정에서 즐거움과 슬픔, 그리고 사랑과 절망이 뒤섞인 감동적인 이야기를 펼쳐낸다. 우도환의 Hae Jo 캐릭터는 그의 최고의 연기를 보여주며, 이유미는 과거의 아픔을 겪고 있는 재미(Jae-mi)의 감정선에 깊이를 더한다.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section4',
      text: '감동을 주는 스토리라인 미스터 플랑크톤',
    ...
    {
      type: 'body',
      html: '<p>그들의 사랑은 비극적이고 감동적인 이야기로, 드라마의 주요 매력 중 하나이다.</p>'
    },
    {
      type: 'h2',
      id: 'section5',
    ...
    {
      type: 'body',
      html: '<p>그 외에도 Alex Landi가 연기한 John Na는 말없이 장면을 훔치는 매력을 지니고 있다. 모든 캐릭터들은 완벽하게 캐스팅되었으며, 각자의 역할을 충실히 소화해냈다.</p>'
    },
    {
      type: 'h2',
      id: 'section6',
      text: '미스터 플랑크톤? 제목이 가진 의의는?',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>드라마의 OST는 감정적인 순간마다 그 분위기를 잘 살려준다. </b></span></p>'
    },
    {
      type: 'body',
      html: '<p>이 드라마는 전반적으로 연기와 연출 모두 뛰어나며, 9/10의 평점을 받을 자격이 충분하다.</p>'
    },
    {
      type: 'body',
      html: '<p>연기와 연출은 10/10으로 평가할 수 있을 정도로 뛰어나다.</p>'
    },
    {
      type: 'ending',
      html: '<p>이 드라마는 감정적으로 매우 몰입할 수 있는 작품으로, 인생과 사랑, 그리고 인물들의 성장에 대한 깊은 성찰을 제공한다. 감동적이고 철학적인 이야기와 훌륭한 연기, 강렬한 감정선을 원한다면 이 드라마를 꼭 추천한다.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
  ]
}
