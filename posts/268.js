const post = {
  ...
  sections: [
    ...
    { type: 'body', html: "<p style=&quot;color: inherit; text-align: start;&quot;>감독 이언희의 로맨스 장르로의 복귀작으로 주연을 맡은 김고은과 노상현의 연기가 특히 호평받았습니다.</p>" },
    { type: 'image', src: "/images/post268_poster.jpg", alt: "포스트 268 관련 이미지", caption: "출처: 네이버 영화" },
    { type: 'body', html: "<p><span style=&quot;background-color: #9feec3;&quot;><b>대도시의 사랑법 한국 평점과 해외 반응 후기 함께 살펴보도록 하겠습니다.</b></span></p>" },
    { type: 'body', html: "<p><span style=&quot;background-color: #9feec3;&quot;><b>대도시의 사랑법 국내 평점입니다.</b></span></p>" },
    { type: 'body', html: "<p><span style=&quot;background-color: #9feec3;&quot;><b>현재 네이버 평점 9.01점을 기록 중인 대도시의 사랑법입니다.</b></span></p>" },
    { type: 'body', html: "<p>주연 배우들의 팬들, 어느정도의 마케팅과 광고에 의한 고 평점을 고려한다고 하여도 상당히 높은 평점을 기록하고 있습니다.</p>" },
    { type: 'body', html: "<p>현재 조커 2 폴리아 되 평점이 처참한 수준을 기록하는 것과 대비되는 결과입니다. 정말 이전 조커의 아성을 처참하게 무너뜨려버린 후속작입니다. 해외 평가 또한 호불호가 갈리는 편이기도 하지만... 극장에서 직접 확인해 보시길 추천드립니다.</p>" },
    { type: 'body', html: "<p><span style=&quot;background-color: #9feec3;&quot;><b>대도시의 사랑법 해외 반응 평점입니다.</b></span></p>" },
    ...
    { type: 'body', html: "<p>10점과 7점이 가장 많은 표본을 차지하고 있고, 앞으로 영화를 시청하는 해외 시청자가 많아질수록 더욱 정확한 표본을 확인할 수 있을 것입니다.</p>" },
    { type: 'body', html: "<p>다음 포스팅에서 대도시의 사랑법 토론토 국제 영화제 시사회 해외 평론가 후기 리뷰 살펴보도록 하겠습니다.</p>" },
    ...
    { type: 'cta', href: "/ending-review-guide/", text: "조커 2 폴리아되 예매 할지 말지 정해드림 | 시사회 결말 후기 노 스포 리뷰 쿠키 총정리" },
