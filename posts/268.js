const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '대도시의 사랑법 국내 평점 9.01점', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: '대도시의 사랑법 해외 반응 평점 분포 분석', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
