  ...
  sections: [
    {
      ...
      text: '조커 2 폴리아되 예매 할지 말지 정해드림 | 시사회 결말 후기 노 스포 리뷰 쿠키 총정리'
    },
    {
      type: 'cta',
    ...
    {
      type: 'intro',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>10월 1일 개봉한 대도시의 사랑법의 행보가 예사롭지 않습니다.</b></span></p><p>사전 예약 4만 4196명을 기록하며 9월 10월의 가을 한국 영화 1위 베테랑 2를 꺾으며 예매 1위에 올랐습니다.</p><p>뿐만 아니라 현재 국내 평가또한 상당히 높으며 흥행을 예고하고 있습니다.</p>'
    },
    {
      type: 'image',
      src: '/images/post268_thumb.svg',
      alt: '대도시의 사랑법 해외 관람평점도 좋은 반응 ! 현재상영작 한국 영화 예매 인기 순위',
      caption: '대도시의 사랑법 해외 관람평점도 좋은 반응 ! 현재상영작 한국 영화 예매 인기 순위'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>대도시의 사랑법 국내 평점입니다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>현재 네이버 평점 9.01점을 기록 중인 대도시의 사랑법입니다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>주연 배우들의 팬들, 어느정도의 마케팅과 광고에 의한 고 평점을 고려한다고 하여도 상당히 높은 평점을 기록하고 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>현재 조커 2 폴리아 되 평점이 처참한 수준을 기록하는 것과 대비되는 결과입니다. 정말 이전 조커의 아성을 처참하게 무너뜨려버린 후속작입니다. 해외 평가 또한 호불호가 갈리는 편이기도 하지만... 극장에서 직접 확인해 보시길 추천드립니다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>대도시의 사랑법 해외 반응 평점입니다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>현재 해외 평점도 8.1점으로 높은 점수를 기록하고 있습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>대도시의 사랑법 평점 분포입니다.</b></span></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><b>국가 표본은 모두 캐나다로 한국 표본이 아닌 명확히 해외 반응임을 알 수 있습니다. </b></p>'
    },
    {
      type: 'body',
      html: '<p><b>토론토 국제 영화제를 시청한 이들의 표본으로 파악되어집니다.</b></p>'
    },
    {
      type: 'body',
      html: '<p>특이한 점은 대부분의 평점 표본에 1점이 반드시 포함되는 것에 반하여 1점이 하나도 없다는 점이 고무적입니다.</p>'
    },
    {
      type: 'body',
      html: '<p>10점과 7점이 가장 많은 표본을 차지하고 있고, 앞으로 영화를 시청하는 해외 시청자가 많아질수록 더욱 정확한 표본을 확인할 수 있을 것입니다.</p>'
    },
    {
      type: 'body',
