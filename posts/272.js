const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '지옥 시즌2 줄거리 — 부활한 정진수와 혼돈의 세계', gradientStyle: 'linear-gradient(to right, #1a1a2e, #e94560)' },
    ...
    { type: 'h2', id: 'section2', text: '지옥 시즌2 주요 등장인물 — 문근영·조동인·양익준', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    { type: 'body', html: "<p><b>주요 등장인물</b></p>" },
    { type: 'body', html: "<p><figure><figcaption>지옥 시즌 2 양익준</figcaption> </figure> <figure><figcaption>지옥 시즌 2 진희정</figcaption> </figure> </p>" },
    { type: 'body', html: "<p><figure><figcaption>지옥 시즌 2 조동인</figcaption> </figure> <figure><figcaption>지옥 시즌 2 문근영</figcaption> </figure> </p>" },
