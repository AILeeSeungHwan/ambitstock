const post = {
  ...
  sections: [
    ...
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section1',
      text: '영화 <어쩔 수가 없다> 원작은 소설 The Ax',
    ...
    {
      type: 'body',
      html: '<p>버크는 경쟁자들의 일상과 습관을 집요하게 추적한다.</p>'
    },
    {
      type: 'body',
      html: '<p>그 과정에서 그는 점점 더 두려움 대신 흥분을 느끼게 되고, 자신이 계획을 실현할수록 “가족을 위해서라면 어쩔 수 없다”라는 자기 합리화에 사로잡힌다.</p>'
    },
    {
      type: 'h2',
      id: 'section3',
    ...
    {
      type: 'body',
      html: '<p>“가족을 위해서라면, 생존을 위해서라면 어디까지 할 수 있는가”</p>'
    },
    {
      type: 'body',
      html: '<p>원작 소설의 결말은 섬뜩하지만 동시에 씁쓸하고, 우리 현실에도 낯설지 않게 다가온다.</p>'
    },
    {
      type: 'body',
      html: '<p>박찬욱 감독이 이 강렬한 소재를 어떻게 한국적으로 풀어낼지, 그리고 원작의 결말을 그대로 가져갈지, 아니면 다른 해석을 덧붙일지는 아직 베일에 싸여 있다. 분명한 건, &lt;어쩔 수가 없다&gt;는 단순한 스릴러가 아닌, 우리 사회를 비추는 날카로운 거울 같은 영화가 될 거라는 점이다.</p>'
    },
    {
      type: 'h2',
      id: 'section6',
      text: '어쩔수가없다 해외 평론가 후기 반응',
