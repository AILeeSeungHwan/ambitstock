const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: '<p>하지만 이 단어적인 뜻 외에 중요한 영화적 의미가 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>함께 확인해 보겠습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>‘위키드(Wicked)’라는 제목은 단순히 \'사악한\'이라는 뜻뿐 아니라, <b>선과 악의 경계를 재조명하며, 사회적 낙인과 진정한 정의의 의미를 찾아 나서는 메시지</b>를 담고 있습니다. 특히, <span style=&quot;background-color: #f3c000;&quot;><b>오즈의 세계에서 벌어지는 동물 탄압과 같은 정치적 이슈도 은유적으로 표현</b></span>됩니다.</p>'
    },
    {
      type: 'body',
      html: '<p>이 작품은 원작 뮤지컬의 감동을 영화로 재현하며 뮤지컬 그 이상의 압도적 경험을 주는 목적으로 제작된 영화로 뮤지컬의 성공을 기반으로 만들어진 팬층들에게 상당한 만족감을 제공해 줄 것으로 기대됩니다.</p>'
    },
    {
      type: 'body',
      html: '<p>앞서 이야기하였듯, <b>영화 위키드(Wicked)는 브로드웨이 뮤지컬의 영화화 작품으로, 오즈의 마법사의 프리퀄 성격</b>을 가지고 있습니다. 원작 소설 《위키드: 서쪽 마녀의 삶과 시간들》을 바탕으로, 두 마녀의 성장과 모험을 다룹니다. <span style=&quot;background-color: #f3c000;&quot;><b>작품은 선과 악의 경계를 허물며, 사회적 편견과 진정한 정체성에 대한 이야기를 중심으로 전개</b></span>됩니다. 요즘 할리우드 영화들의 대부분 콘셉트는 차별과 편견을 깨고 다양성을 존중해야 한다는  의지가 명확히 드러나는 것 같습니다.</p>'
    },
    {
      type: 'h2',
      id: 'section3',
    ...
    {
      type: 'body',
      html: '<p>한편, <b>글린다는 사회적 성공과 명성을 추구하며 엘파바와는 다른 선택</b>을 하게 되고, 두 사람의 관계는 점점 복잡해집니다. 영화는 <span style=&quot;background-color: #f3c000;&quot;><b>엘파바가 악의 화신으로 낙인찍히는 과정을 묘사</b></span>하며, 그녀가 진정한 정의를 위해 어떤 희생을 감수해야 하는지 그려냅니다.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
    ...
    {
      type: 'body',
      html: '<ul style=&quot;list-style-type: disc;&quot;> <li><b>글린다 (아리아나 그란데)</b>: 매력적이고 인기가 많은 마녀로, 엘파바와 대비되는 인물</li> </ul>'
    },
    {
      type: 'body',
      html: '<ul style=&quot;list-style-type: disc;&quot;> <li><b>오즈의 마법사 (제프 골드블룸)</b>: 오즈의 통치자로, 선한 척 하지만 사실은 권력을 위해 억압을 일삼는 인물</li> </ul>'
    },
    {
      type: 'body',
      html: '<p>이상으로 영화 위키드에 대한 영화제목 뜻 의미 해석, 그리고 줄거리 내용에 대한 포스팅 마칩니다.</p>'
    },
    {
      type: 'body',
      html: '<p>다음 포스팅에서 위키드에 대한 시사회 후기 관람평 알아보겠습니다.</p>'
    },
    {
      type: 'ending',
      html: '<p>감사합니다.</p>'
