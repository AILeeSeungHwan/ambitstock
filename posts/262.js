const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post262_thumb.svg',
      alt: '더 플랫폼 2 해외 평론가 평점 반응 넷플릭스 영화 후속작은 왜 항상 이런 결말인가',
      caption: '더 플랫폼 2 해외 평론가 평점 반응 넷플릭스 영화 후속작은 왜 항상 이런 결말인가'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>영화 더 플랫폼 2 인기 순위 및 평점입니다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #f3c000;&quot;><b>IMDB 평점은 5.0점, 인기순위는 872위입니다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>낮은 평점도 평점이지만 재밌는 점은 더 플랫폼 2의 인기순위보다 전작의 인기순위가 수백 위 차이 난다는 점입니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>총 표본 수는 6천 개 이상이며, 5점대의 애매한 평가가 대부분을 차지하고, 1점을 준 평점도 상당히 많습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>망작에서 자주 볼 수 있는 평점 분포를 보이고 있는 더 플랫폼 2입니다.</p>'
    },
    {
      type: 'body',
      html: '<p>전작의 기대치가 너무 높았던 탓일까요. 아니면 이러한 콘셉트를 가진 작품들이 후속작에서는 신선함이 떨어지기 때문에 발생하는 지루함 때문일까요.</p>'
    },
    {
      type: 'body',
      html: '<p>다음 포스팅에서 더 플랫폼 2 해외 시청자 후기반응 리뷰 살펴보겠습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>감사합니다.</p>'
