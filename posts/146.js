const post = {
  ...
  sections: [
    ...
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section1',
      text: '드라마 조명가게 해외반응 평점 후기를 알아보자',
    ...
    },
    {
      type: 'h2',
      id: 'section3',
      text: '디즈니 플러스 드라마 조명가게 평점 인기 순위',
    ...
    { type: 'image', src: '/images/post146_img4.jpg', alt: '조명 가게 평점', caption: 'ⓒ R의 필름공장' },
    {
      type: 'h2',
      id: 'section6',
      text: '조명가게 시즌 2를 간절히 원하는 해외 시청자들',
    ...
    {
      type: 'body',
      html: '<p>다음 포스팅에서 이러한 해외 시청자들의 조명가게 후기 관람평 리뷰 살펴보도록 하겠습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>감사합니다.</p>'
