const post = {
  ...
  sections: [
    ...
    },
    {
      type: 'h2',
      id: 'section2',
      text: '영화 나의 히어로 아카데미아 더 무비: 유어 넥스트 로튼토마토 평론가 평점',
    ...
    },
    {
      type: 'h2',
      id: 'section3',
      text: '나의 히어로 아카데미아 더 무비: 유어 넥스트 시사회 후기 관람평',
    ...
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Charles Solomon - 평점 없음</span></i><br>이 영화는 매우 재미있고 액션이 풍부하다. 특히 데쿠의 많은 팬들이라면 큰 즐거움을 느낄 수 있을 것이다.</br></p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Chris Sawin - 평점(3/5)</span></i><br>애니메이션이 고르지 못하고, 대사도 불쾌할 정도로 어색하며, 일차원적인 악당들이 등장한다.</br></p>'
    },
    {
      type: 'body',
      html: '<p>&quot;You’re Next&quot;는 자신이 불필요함을 알리고 싶어 하는 듯한 영화로 보인다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Mikkel Synder - 평점 없음</span></i><br/>이 영화를 있는 그대로 즐기자: 더 많은 My Hero지만 그 이상은 기대하지 말자.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Rachel Wagner - 평점 없음</span></i><br/>특히 영화의 시작과 끝 부분의 액션 장면은 마블 영화에서 최근에 본 것 중에서도 최고라고 할 수 있다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Danae Stahlnecker - 평점 없음</span></i><br/>이 드라마틱하고 격렬한 싸움이 가득한 영화는 인기 있는 고등학교 히어로 애니메이션의 재미있는 독립적 작품이다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Victor Recinos - 평점(4/5)</span></i><br/>호리코시 코헤이의 영웅들이 큰 화면으로 돌아온 폭발적인 모험이다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Tessa Smith - 평점 없음</span></i><br/>My Hero Academia: You\'re Next는 잘 사랑받는 애니메이션 프랜차이즈에 많은 것을 더하며, 유머와 감정적인 순간을 완벽하게 전달하고, 강력한 액션 장면을 제공한다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Jeffrey Harris - 평점(8/10)</span></i><br/>이 영화는 데쿠의 성장을 강조하며, All For One의 완전한 잠재력을 발휘한다.</p>'
    },
    {
      type: 'body',
      html: '<p>다른 동급생들도 충분한 출연 시간을 갖고 있으며, 애니메이션 액션 어드벤처로 시리즈 팬들에게 큰 즐거움을 선사한다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Daniel Kurland - 평점(3/5)</span></i><br/><b>나의 히어로 아카데미아 더 무비: 유어 넥스트</b>는 강력한 원작 이야기를 다루며, 말의 무게와 공공 영웅이 될 때의 양면성을 보여준다.</p>'
    },
    {
      type: 'body',
      html: '<p>애니메이션의 법 없는 마지막 시즌을 고려했을 때 이 영화는 더 큰 울림을 준다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Mike McGranaghan - 평점(3/4)</span></i><br/><b>나의 히어로 아카데미아 더 무비: 유어 넥스트</b>는 상상력이 넘치는 작품이다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Aidan Kelley - 평점(7/10)</span></i><br/><b>나의 히어로 아카데미아 더 무비: 유어 넥스트</b>는 꾸준히 관객들에게 큰 인기를 끌며, 엄청난 캐릭터들과 창의적인 액션 세트피스를 특징으로 하는 슈퍼히어로 대작이다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Cain Noble-Davies - 평점(16/20)</span></i><br/>이 영화는 유쾌하고 전율을 일으키는 슈퍼히어로 영화로, 유머와 영웅주의의 본질, 그리고 진정한 힘을 지닌 자가 무엇을 의미하는지에 대한 흥미로운 발언을 잘 섞어낸 작품이다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Avi Offer - 평점 없음</span></i><br/>액션으로 가득 찬, 그러나 지치고 복잡한 애니메이션 영화다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Zach Pope - 평점(B)</span></i><br/>나의 히어로 아카데미 팬들에게 강력히 추천한다!</p>'
    },
    {
      type: 'body',
      html: '<p>창의적인 전투와 빠른 액션, 멋진 팀업으로 가득하다. Dark Might의 사용도 훌륭하며, 슈퍼맨의 비자로 같은 설정을 좋아하는 만화 팬들은 이 점을 재미있게 느낄 것이다.</p>'
    },
    {
      type: 'body',
      html: '<p>이상으로 영화 나의 히어로 아카데미아 더 무비: 유어 넥스트 해외 관람평 후기 마칩니다.</p>'
    },
    {
      type: 'ending',
      html: '<p>감사합니다.</p>'
