const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post465_thumb.svg',
      alt: '[스즈메의 문단속 - 다녀왔어 특별판 개봉 예정작] 해외반응, 평점 및 줄거리 리뷰, 관객수 넷플릭스 공개정보',
      caption: '[스즈메의 문단속 - 다녀왔어 특별판 개봉 예정작] 해외반응, 평점 및 줄거리 리뷰, 관객수 넷플릭스 공개정보'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p><b>Emma steen - Time Out </b><b><span style=&quot;color: #f3c000;&quot;><span style=&quot;letter-spacing: 0px;&quot;>8점</span></span></b></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><b>Udita Jhunjhunwala - Scroll.in </b></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><b> Larushka Ivan-Zadeh - metro.co.uk </b><b><span style=&quot;color: #f3c000;&quot;><span style=&quot;letter-spacing: 0px;&quot;>10점</span></span></b></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><b>Tim Robey - Daily Telegraph (UK) </b><b><span style=&quot;color: #f3c000;&quot;><span style=&quot;letter-spacing: 0px;&quot;><span>8점</span></span></span></b></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;color: #1a5490;&quot;> <b>평점 3.9/5</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>일본 영화 리뷰 사이트인 Filmarks의 영화 &lt;스즈메의 문단속&gt; 평점입니다. 5점 만점의 3.9점으로 높은 평점을 기록하고 있습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>신카이 마코토 감독 작품으로 흥미가 있어 보았지만, 너의 이름은에서 날씨의 아이로 갈 수록 점점 이야기가 심플하지 않은 생각이 들고 있어. 초기 작품이 더 재밌다.</p>'
    },
    {
      type: 'body',
      html: '<p><b>東雲の感想・評価 </b><b><span style=&quot;color: #f3c000;&quot;><span style=&quot;letter-spacing: 0px;&quot;>8점</span></span></b></p>'
    },
    {
      type: 'body',
      html: '<p>드디어 보았습니다.<br/>취향차이가 있겠지만, 개인적으로는 비교적 제 취향이었습니다.</p>'
    },
    {
      type: 'body',
      html: '<p><b>Masanの感想・評価 </b><b><span style=&quot;color: #f3c000;&quot;><span style=&quot;letter-spacing: 0px;&quot;>6.6점</span></span></b></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>현재(24.01.08 월요일) 기준 넷플릭스와 기타 구독 OTT플랫폼에서는 스즈메의 문단속을 시청하실 수 없습니다. YouTube, Watcha, Google Play 무비/TV, 웨이브 등에서 유료로 시청하시거나, 더 큰 화면으로 영화관에서 재개봉(24.01.10 수요일) 시청하시길 바랍니다.</p>'
    },
    {
      type: 'body',
