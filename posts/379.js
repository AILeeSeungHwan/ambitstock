const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '영화 트위스터스 제목 뜻과 기본 정보', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: '영화 트위스터스 등장인물 배우 캐스팅', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
    { type: 'body', html: '<p> </p>' },
    { type: 'body', html: '<p> </p>' },
    ...
    { type: 'h2', id: 'section3', text: '영화 트위스터스 로튼토마토 평점', gradientStyle: 'linear-gradient(to right, #6a1b9a, #ab47bc)' },
