const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '흑백요리사 영어제목과 프로그램 소개', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: 'IMDB 해외 평점과 평점 분포', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
    ...
    { type: 'h2', id: 'section3', text: '마스터셰프 복사판? — 1점 평론가 후기 분석', gradientStyle: 'linear-gradient(to right, #00897b, #26a69a)' },
