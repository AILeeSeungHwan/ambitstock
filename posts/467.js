const post = {
  ...
  sections: [
    {
      type: 'cta',
      href: 'https://ambitstock.com/2',
      text: '[한소희를 좋아했지만] 경성크리처 논란 및 해외반응, 일본 평점 리뷰 - 시즌2 파트2 일정 넷플릭'
    },
    {
      type: 'intro',
    ...
    {
      type: 'image',
      src: '/images/post467_thumb.svg',
      alt: '[경성크리처 파트2 의도적 평점테러] 배우들의 일본어발음 일본 반응 및 해외 평점 - 시즌2 개봉 예정작',
      caption: '[경성크리처 파트2 의도적 평점테러] 배우들의 일본어발음 일본 반응 및 해외 평점 - 시즌2 개봉 예정작'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><b><span> 파트2  공개전          -&gt;   공개후</span></b></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><b>표본수 </b><span style=&quot;color: #9d9d9d;&quot;>3,200개</span><b>          -&gt;   <span style=&quot;background-color: #f3c000;&quot;>4,700개</span></b></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><b>평점 </b><span style=&quot;color: #9d9d9d;&quot;>7.3점</span> <b>             -&gt;    <span style=&quot;background-color: #f3c000;&quot;>7.4점</span></b></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><b><b>인기순위</b></b> <span style=&quot;color: #9d9d9d;&quot;>147 등</span><b>    -&gt;    <span style=&quot;background-color: #f3c000;&quot;>30등</span></b></p>'
    },
    {
      type: 'body',
      html: '<p>표본수 상승과 더불어 평점 및 인기순위도 상승한 모습입니다. 하지만 여전히 로튼 토마토 평점보다는 낮은 모습을 보이고 있습니다. 아래 자료를 통하여 총 표본 4,700개 평점의 분포도를 확인하실 수 있습니다. 의도적으로 1점을 준 평점이 많은 것으로 보아 작품의 역사성과 반일감정을 더불어, 한소희배우님의 인스타 글이 일본 네티즌들에게 영향을 미친 것으로 보입니다. 얼른 일본반응을 살펴 보아야겠습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><figure class=&quot;imageblock widthContent&quot; data-origin-height=&quot;655&quot; data-origin-width=&quot;855&quot;><span data-alt=&quot;경성크리처 시즌1 파트2 평점분포&quot; data-phocus=&quot;https://blog.kakaocdn.net/dna/b0XU1v/btsC3966fXH/AAAAAAAAAAAAAAAAAAAAAHx8isriRiVWTFGqUmwTXXOkP3SqZFUJ_2ormokb-eMn/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=DjRPL3XxUU4SqTZJVgE6pcKwD2o%3D&quot; data-url=&quot;https://blog.kakaocdn.net/dna/b0XU1v/btsC3966fXH/AAAAAAAAAAAAAAAAAAAAAHx8isriRiVWTFGqUmwTXXOkP3SqZFUJ_2ormokb-eMn/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=DjRPL3XxUU4SqTZJVgE6pcKwD2o%3D&quot;></span><figcaption>경성크리처 시즌1 파트2 평점분포</figcaption> </figure> </p>'
    },
    {
      type: 'h2',
      id: 'section3',
    ...
    {
      type: 'body',
      html: '<p>파트1까지의 평점은 2.7점이었고, 현재는 0.2점 상승한 2.9점을 기록하고 있습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>한국에서도 꽤 제작비를 들었다는 드라마.<span> </span>스토리는 재미있고 단번에 끝까지 보았다.<br>몬스터와의 싸움이라 생각했는데, 인간 드라마가 메인. 배우들도 모두 연기가 좋고, 박서준과 한서희도 틀림없이 좋았다!</br></p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;color: #ef6f53;&quot;>(일본어 번역때 자주 볼 수 있는 표현인 틀림없이 좋았다!)</span></i><br>다만, 일본인 역의 한국 배우들의 발음은 조금 신경이 쓰인다.<span> </span>퀄리티를 높게 한다면 주요한 인물들은 일본인으로 해도 좋았을지도…? 일본 통치 시대의 이야기로 나쁘게 쓰는 것은 어쩔 수 없고 731부대도 차분히 조사하는 계기가 되었기 때문에, 반드시 반일 드라마라고는 생각하지 않았다.</br></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>2024년의 시작은 기대하고 있던 경성 크리쳐 보기 전에는 일본인에 의한 작품 비판이나 배우에 대한 비방때문에 머리가 아팠다. 하지만 작품을 보고 731부대를 조사하는 계기가 되었다. 일본이 하고 있던 것은</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><span style=&quot;color: #953b34;&quot;><b><i>나라를 빼앗아, </i></b></span><span style=&quot;color: #953b34;&quot;><b><i>말을 빼앗아, </i></b></span><span style=&quot;color: #953b34;&quot;><b><i>생활을 빼앗아, </i></b></span><span style=&quot;color: #953b34;&quot;><b><i>소중한 사람을 빼앗아, </i></b></span><span style=&quot;color: #953b34;&quot;><b><i>인간의 존엄 을 빼앗는 것 </i></b></span></p>'
    },
    {
      type: 'body',
      html: '<p>이런 세상이 아니면<span> </span>경험하지 않아도 되는 것</p>'
    },
    {
      type: 'body',
      html: '<p><span> </span>&quot;이렇게 괴로워도<span> </span>모두가 견디고 있는 것은<span> </span>아무리 굴욕적이라도<span> </span>살아남아야 하기 때문에,<span> </span>우리가 살아남지 않으면<span> </span>그 사실이 잊혀져 버리니까<span> </span>&quot; &quot;하자, 밖은 아직 춥다&quot;라는 말의 따뜻함<span> </span></p>'
    },
    {
      type: 'body',
      html: '<p><span>괴물의</span><span> </span>디자인은 좋아하지 않았고<span> </span>일본어에 대한 위화감은 있었지만<span> </span>원래 일본을 향해<span> </span>만들어진 작품이 아니기 때문에<span> </span>이 정도로도 좋다. 이렇게도<span> </span>외국어의 대사가 많은 작품을<span> </span>해 온 배우들이 굉장하다</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>어!<span> </span>정말 재미있는 드라마! 왜 이렇게 평가가 낮은건가? 내 감각이 이상해?<br/>일본 통치 시대의 이야기이기 때문에 일본인이 악으로 그려지는 것은 어쩔 수 없다고 생각하고 보고 있기 때문에 이것에 대해서는 생각하지 않고, 괴물이야기와 얽혀 가족의 유대나 이 시대의 여러가지 관계의 표현이 좋았지만.<span> </span>.</p>'
    },
    {
      type: 'body',
      html: '<p>일본어가 심각하게 별로라는 것 같은 리뷰 보았습니다만, 한국의 배우를 기준으로 보면 일본어는 외국어<br/>외국어로 연기한다고 힘들다고 생각합니다만 엄청 일본어 능숙하다고 생각했습니다.<br/>박서준은 지금까지는 없는 역할에 도전하고 있어 멋있었고 한서희는 액션이 ​​굉장히 어울려서 러브 스토리의 그녀도 귀엽다고 생각하지만 어떤 역할도 멋지고 좋았습니다 속편이 있을 것 같은 마지막 즐거움 </p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>일본 통치하의 한국이 무대에서 731부대가 모티브라고 생각되기 때문에 확실히 일본인으로서는 마음이 좋지 않은 부분이 있지만, 반일 드라마라고 까지는 느끼지 않았다.<span> </span>영화라든지에 있어서 나치 독일 등의 그리는 방법과 같지 않다.<span> </span>엔터테인먼트 작품으로 보통 재미있었다.<span> </span>한국인 배우의 탐욕스러운 일본어는 애교.<span> </span>하지만 마에다씨(수현)의 교토 도시락은 꽤 능숙하다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>만일 진실이 하나 있었다고 해도, 픽션은 얼마든지 만들어 바꿀 수 있다.<span> </span>덧붙일 수 있다.<br/>박서준이 왜 이 각본을 선택했는가.<span> </span>혹은 승낙했는가.<span> </span>심의가 알고 싶지만, 반드시 세계적으로 유명해진 한국 배우는 이런 일이 일어난다.<span> </span>반일의 발판처럼 보인다.<span> </span>한소희는 선택한 느낌은 들지만.</p>'
    },
    {
      type: 'body',
      html: '<p>리뷰를 선별적으로 추린것도 아니고 순서대로 가져왔음에도 작품성 자체만으로 좋은 평가를 받고 있는 것을 알 수 있습니다. 중간에 나라를, 말을, 생활을, 소중한 사람을, 인간의 존엄을 빼앗았다는 리뷰에서 지난 역사에 대한 반성의 표현또한 볼 수 있었습니다.</p>'
    },
    {
      type: 'ending',
      html: '<p>시즌1 마지막 쿠키영상을 통하여 시즌2 파트3가 예정되어 있다는 점을 알 수 있습니다. 일본 네티즌들의 리뷰에서도 그와 관련된 내용이 포함되어 있네요. 시즌2는 현재 제작중이며 2024년 공개예정이라 합니다. 추후 공개되는 시즌2도 빠르게 해외 반응 살펴보도록 하겠습니다.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
  ]
}
