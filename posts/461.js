const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '베테랑 박스오피스 순위와 기본 정보', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: 'IMDB 평점 7.0 — 로튼토마토 90%와 대조적인 결과', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
