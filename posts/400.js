const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '최애의 아이 2기 일본 현지 평점', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: 'IMDB 해외 평점 — 시즌 1 대비 반응', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
    ...
    { type: 'h2', id: 'section3', text: '일본 현지 후기 — 긍정 및 부정 반응', gradientStyle: 'linear-gradient(to right, #6a1b9a, #ab47bc)' },
    ...
    { type: 'h2', id: 'section4', text: '1화 평점 분포 및 최애의 아이 2기 보는 곳', gradientStyle: 'linear-gradient(to right, #00897b, #26a69a)' },
