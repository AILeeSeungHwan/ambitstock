const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: '<p>JU건설의 내부 감사실을 배경으로 한 오피스 수사극!</p><p>현재 2화까지 방영 된 드라마 \'감사\'합니다의 <span style=&quot;background-color: #f3c000;&quot;><b>시청률은 1화에서 3.5%, 2화 시청률 5.9%</b></span>까지 오르며 가파른 상승세를 이어가고 있습니다.</p><p>여기서 드라마 제목인 감사합니다 의 뜻을 살펴보면,</p>'
    },
    {
      type: 'image',
      src: '/images/post394_thumb.svg',
      alt: 'TVN 주말 드라마 추천 감사합니다 등장인물관계도 줄거리 제목 뜻을 아시나요 | 티빙',
      caption: 'TVN 주말 드라마 추천 감사합니다 등장인물관계도 줄거리 제목 뜻을 아시나요 | 티빙'
    },
    { type: 'toc' },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'body',
      html: '<p>제목의 \'감사\'는 우리가 흔히 인사할 때 쓰는 감사가 아닌, 아래의 뜻을 따릅니다.</p>'
    },
    {
      type: 'body',
      html: '<p>신하균 이정하 진구 조아람 주연의 tvn 12부작 토일 주말 드라마 \'감사합니다\'</p>'
    },
    {
      type: 'body',
      html: '<p>등장인물 관계도 및 줄거리를 소개 시작하겠습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>드라마 감사합니다는 토일 9시 20분 tvn에서 시청가능합니다.</p>'
    },
    {
      type: 'body',
      html: '<p>OTT 스트리밍은 티빙에서 시청가능합니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;>횡령의 사전적 의미는 ‘공금이나 타인의 재물을 불법적으로 차지하여 소유하는 행위’를 의미하지만,<span> </span></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;>이 범죄는 믿음과 의리를 배신하는 측면에서 다른 범죄와 구별됩니다.<br/><br/>사람들의 <span style=&quot;color: #781b33;&quot;><b>믿음을 이용해 교묘하게 비리를 저지르며 이익을 취하는 횡령범</b></span>들을<span> </span></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;>신차일 팀장과 구한수 사원처럼 <span style=&quot;background-color: #f3c000;&quot;><b>냉철하게 분석하고 판단하는 사람들, 즉 감사인</b></span>이 있습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><br/>과거 드라마에서는 감사인이 주로 <span style=&quot;color: #781b33;&quot;><b>상자 안의 컴퓨터와 서류를 가지고 빠르게 퇴장하는 장면</b></span>으로 그려졌지만,<span> </span></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;>이 드라마는 검찰과 경찰처럼 행동하면서도 상담사 역할까지 수행하는 감사팀의 이야기를 풀어내며,<span> </span></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;>오염된 사회에 경종을 울리기 위한 믿음의 의미를 전달합니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><br/>지능이라면 지능, 완력이면 완력, 꼼수라면 꼼수로 응전하는 이성파 신차일 팀장과<span> </span></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;>사람을 믿고 싶어하는 감성파 구한수 사원은 회사 내 비리를 처단하기 위해 더불어 노력합니다.<br/><br/><span style=&quot;background-color: #01ff51;&quot;><b>탄산이 터지듯이 짜릿하고 유쾌한 오피스 수사 활극 &lt;감사합니다&gt;</b></span></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;>위로와 웃음,<span> </span>재미와 감동을 선사하며, 사람에 대한 믿음의 중요성을 강조합니다.</p>'
    },
    {
      type: 'body',
      html: '<p><br/>신차일 (신하균)</p>'
    ...
    {
      type: 'body',
      html: '<p>신차일은 JU건설 감사실 팀장으로, 사람에 대한 믿음이 없고 전광석화 같은 판단력과 칼 같은 결단력을 자랑합니다.</p>'
    },
    {
      type: 'body',
      html: '<p>그의 언변과 협상 능력은 상대를 압도할 정도로 뛰어나며,</p>'
    },
    {
      type: 'body',
      html: '<p>감정과 혈연, 지연에 흔들리지 않고 횡령범에게는 가차 없는 감사팀장 그 자체입니다.</p>'
    },
    {
      type: 'body',
      html: '<p>신차일은 회사 내부의 부정부패를 밝히기 위해 냉철하게 사건을 분석하고 해결해 나갑니다.</p>'
    },
    {
      type: 'body',
      html: '<p><br/>구한수 (이정하)</p>'
    ...
    {
      type: 'body',
      html: '<p><br/>구한수는 MZ세대 대표주자로,</p>'
    },
    {
      type: 'body',
      html: '<p>JU건설 플로리다 지사 발령을 목표로 감사팀에 지원했으나, 신차일로 인해 그 꿈이 박살 날 위기에 처합니다.</p>'
    },
    {
      type: 'body',
      html: '<p>구한수는 <span style=&quot;background-color: #f3c000;&quot;><b>정 많고 헤픈 스타일로 감사팀에서 쫓겨날 뻔도 하지만</b></span>, 굴하지 않는 패기로 성장해 나가는 캐릭터입니다.</p>'
    },
    {
      type: 'body',
      html: '<p>신차일과의 갈등과 협력을 통해 자신의 능력을 키워갑니다.</p>'
    },
    {
      type: 'body',
      html: '<p><br/>황대웅 (진구)</p>'
    ...
    {
      type: 'body',
      html: '<p><br/>황대웅은 JU건설 창업자의 막내아들이자 부사장</p>'
    },
    {
      type: 'body',
      html: '<p>누구든 \'내 사람\'으로 만들 줄 아는 카리스마의 소유자이며, <b><span style=&quot;background-color: #f3c000;&quot;>형들을 제치고 사장직에 오르겠다는 야망</span></b>을 품고 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>그러나 감사팀에 신차일이 영입되면서 그의 계획에 차질이 생기고,</p>'
    },
    {
      type: 'body',
      html: '<p>두 사람 간의 갈등이 극에 달합니다.</p>'
    },
    {
      type: 'body',
      html: '<p><br/>윤서진 (조아람)</p>'
    ...
    {
      type: 'body',
      html: '<p><br/>윤서진은 JU건설 감사실의 또다른 MZ세대 신입사원</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #f3c000;&quot;><b>성공을 지향하는 개인주의자로, 동기인 구한수와는 전혀 다른 극과 극 캐릭터</b></span>입니다.</p>'
    },
    {
      type: 'body',
      html: '<p>부사장인 황대웅과는 어릴 때부터 인연이 있으나 회사에서는 모르는 사이처럼 지냅니다.</p>'
    },
    {
      type: 'body',
      html: '<p>그녀는 감사팀에서 자신의 능력을 발휘하며, 황대웅과의 복잡한 관계 속에서 성장해 나갑니다.</p>'
    },
    {
      type: 'body',
      html: '<p>2화에서 황대웅과 윤서진이 사실 가족임이 밝혀집니다.</p>'
    },
    {
      type: 'body',
      html: '<p><br/>드라마는 JU건설 내부의 횡령 사건을 중심으로 전개됩니다. 신차일은 감사팀을 이끌며 회사 내 비리와 부패를 척결하기 위해 노력합니다. 그는 구한수와 윤서진과 함께 각종 사건을 해결하며, 팀원들과의 신뢰를 쌓아갑니다.</p>'
    },
    {
      type: 'body',
      html: '<p>한편, 황대웅은 형들을 제치고 사장직을 노리며, 신차일과의 갈등을 겪습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>그는 자신의 야망을 이루기 위해 수단과 방법을 가리지 않지만, 신차일의 철저한 감사와 조사로 인해 어려움을 겪습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>윤서진은 황대웅과의 과거 인연을 통해 그의 비밀을 알게 되고,</p>'
    },
    {
      type: 'body',
      html: '<p>이를 통해 회사 내 권력 다툼에 휘말리게 됩니다.</p>'
    },
    {
      type: 'body',
      html: '<p><br/>드라마 감사합니다는 신차일과 감사팀이 회사 내 비리와 부패를 밝히고, 정의를 실현하는 과정을 통해 감동과 카타르시스를 선사합니다.</p>'
    },
    {
      type: 'body',
