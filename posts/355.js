const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '넷플릭스 영화 크로스 IMDB 평점 — 6.1점의 저조한 성적', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'body', html: "<p>영화 크로스(영어제목 MISSION CROSS) IMDB 평점입니다.</p>" },
    { type: 'body', html: "<p><span style=&quot;background-color: #f3c000;&quot;><b>10점 만점에 6.1점으로 상당히 저조한 성적을 기록</b></span>하고 있습니다.</p>" },
    { type: 'body', html: "<p><span style=&quot;background-color: #01ff51;&quot;><b>평점분포를 보면 6,7점대가 주를 이루고 있고, 전체적으로 상당히 낮은 점수를 기록</b></span>하고 있음을 알 수 있습니다.</p>" },
    { type: 'body', html: "<p>특히나 한국에서 측정한 평점보다 <span style=&quot;background-color: #01ff51;&quot;><b>미국, 인도 분포가 높은것으로 보아 해외에서의 반응은 상당히 차가운 것</b></span>을 알 수 있습니다.</p>" },
    { type: 'image', src: "/images/post355_img3.jpg", alt: "넷플릭스 영화 크로스 평점", caption: "ⓒ R의 필름공장" },
    { type: 'h2', id: 'section2', text: '넷플릭스 영화 크로스 스틸컷 — 황정민 염정아 주연', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
    { type: 'body', html: "<p>다음은 영화 크로스의 관람평 후기입니다.</p>" },
