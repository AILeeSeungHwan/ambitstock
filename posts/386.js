const post = {
  ...
  sections: [
    ...
    { type: 'image', src: "/images/post386_thumb.svg", alt: "명탐정코난: 100만 달러의 펜타그램 일본 해외 반응 평점 결말 후기 줄거리 | 아이들과 볼만한 영화 현재 상영작 1위 극장판 추천", caption: "명탐정코난: 100만 달러의 펜타그램 일본 해외 반응 평점 결말 후기 줄거리 | 아이들과 볼만한 영화 현재 상영작 1위 극장판 추천" },
    { type: 'toc' },
    ...
    { type: 'body', html: "<p><figure><figcaption>명탐정코난 100만 달러의 펜타그램</figcaption> </figure> </p>" },
    ...
    { type: 'body', html: "<p><figure><figcaption>명탐정코난 극장판 100만 달러의 펜타그램</figcaption> </figure> </p>" },
    { type: 'body', html: "<p><figure><figcaption>명탐정코난 100만 달러의 펜타그램</figcaption> </figure> </p>" },
    ...
    { type: 'body', html: "<p><figure><figcaption>명탐정코난 100만 달러의 펜타그램 현지 평점</figcaption> </figure> </p>" },
