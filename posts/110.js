const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post110_thumb.svg',
      alt: '넷플릭스 영화 추천 이동진 박평식 평론가 순위 TOP 20, 2025',
      caption: '넷플릭스 영화 추천 이동진 박평식 평론가 순위 TOP 20, 2025'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p>이러한 <b>박평식 평론가가 높은 평점을 준 넷플릭스에서 시청가능한 영화들</b>을 모아보았습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>순위는 평점순입니다.</p>'
    ...
    {
      type: 'body',
      html: '<p>1958년, 타 인종 간의 결혼이 불법이었던 미국 버지니아 주</p>'
    },
    {
      type: 'body',
      html: '<p>서로를 영원히 지켜주고, 언제든 함께하기로 맹세한 ‘러빙 부부’가</p>'
    },
    {
      type: 'body',
      html: '<p><br><span style=&quot;background-color: #9feec3;&quot;><b>오직 사랑으로 세상을 바꾼 위대한 러브 스토리</b></span></br></p>'
    },
    {
      type: 'h2',
      id: 'section3',
    ...
    {
      type: 'body',
      html: '<h3>퍼스널 쇼퍼 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p>프랑스 파리에서 퍼스널 쇼퍼로 일하는 미국 여성 ‘모린’(크리스틴 스튜어트).</p>'
    },
    {
      type: 'body',
      html: '<p><b>영혼들과 소통할 수 있는 능력을 가진 그녀</b>는 최근 쌍둥이 오빠의 죽음으로 힘든 시간을 보내고 있다.</p>'
    },
    {
      type: 'body',
      html: '<p>그러던 어느 날, <b>정체불명의 존재로부터 의문의 문자 메시지</b>가 오는데…</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>“난 널 알아, 너도 날 알고, 내 정체가 궁금하지 않나?”</b></span></p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
    ...
    {
      type: 'body',
      html: '<h3>시카리오: 암살자의 도시 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p><b>하나의 작전, 서로 다른 목표. 당신이 믿었던 정의가 파괴된다.</b></p>'
    },
    {
      type: 'body',
      html: '<p>사상 최악의 마약 조직을 소탕하기 위해 미국 국경 무법지대에 모인 FBI 요원 케이트(에밀리 블런트)와 CIA 소속의 작전 총책임자 맷(조슈 브롤린), 그리고 작전의 컨설턴트로 투입된 정체불명의 남자 알레한드로(베니치오 델 토로).</p>'
    },
    {
      type: 'body',
      html: '<p>누구도 믿을 수 없는 극한 상황 속, 세 명의 요원들이 서로 다른 목표를 향해 움직인다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>숨 쉬는 모든 순간이 위험한 이곳에서 이들의 작전은 성공할 수 있을까!</b></span></p>'
    },
    {
      type: 'h2',
      id: 'section5',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>당신의 마지막, 나의 처음... 모든 걸 내던질 수 있는 사랑. </b></span></p>'
    },
    {
      type: 'body',
      html: '<p>1950년대 뉴욕, 맨해튼 백화점 점원인 테레즈(루니 마라)와 손님으로 찾아온 캐롤(케이트 블란쳇)은 처음 만난 순간부터 거부할 수 없는 강한 끌림을 느낀다. 하나뿐인 딸을 두고 이혼 소송 중인 캐롤과 헌신적인 남자친구가 있지만 확신이 없던 테레즈, 각자의 상황을 잊을 만큼 통제할 수 없이 서로에게 빠져드는 감정의 혼란 속에서 둘은 확신하게 된다.</p>'
    },
    {
      type: 'body',
      html: '<p><b><span style=&quot;background-color: #9feec3;&quot;>인생의 마지막에, 그리고 처음으로 찾아온 진짜 사랑임을…</span></b></p>'
    },
    {
      type: 'h2',
      id: 'section6',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>시체 처리반으로 일하던 남자 앞에 오늘, 아들의 주검이 도착했다… </b></span></p>'
    },
    {
      type: 'body',
      html: '<p>나치의 만행이 극에 달했던 1944년, 아우슈비츠 수용소에는 시체들을 처리하기 위한 비밀 작업반이 있었다. ‘존더코만도’라 불리던 이들은 X자 표시가 된 작업복을 입고 아무것도 묻지 않고 오직 시키는 대로 주어진 임무를 수행한다.</p>'
    },
    {
      type: 'body',
      html: '<p>그러던 어느 날, ‘존더코만도’ 소속이었던 남자 ‘사울’의 앞에 어린 아들의 주검이 도착한다.</p>'
    },
    {
      type: 'body',
      html: '<p>처리해야 할 시체더미들 사이에서 <span style=&quot;background-color: #9feec3;&quot;><b>아들을 빼낸 ‘사울’은 랍비를 찾아 제대로 된 장례를 치러주기로 결심하는데…</b></span></p>'
    },
    {
      type: 'h2',
      id: 'section7',
    ...
    {
      type: 'body',
      html: '<p><b><span style=&quot;background-color: #9feec3;&quot;>“폐 끼치고 싶진 않았어요.” </span></b></p>'
    },
    {
      type: 'body',
      html: '<p>전원백수로 살 길 막막하지만 사이는 좋은 기택(송강호) 가족. 장남 기우(최우식)에게 명문대생 친구가 연결시켜 준 고액 과외 자리는 모처럼 싹튼 고정수입의 희망이다.</p>'
    },
    {
      type: 'body',
      html: '<p>온 가족의 도움과 기대 속에 박사장(이선균) 집으로 향하는 기우.</p>'
    },
    {
      type: 'body',
      html: '<p>글로벌 IT기업 CEO인 박사장의 저택에 도착하자 젊고 아름다운 사모님 연교(조여정)가 기우를 맞이한다.</p>'
    },
    {
      type: 'body',
      html: '<p>그러나 이렇게 시작된 두 가족의 만남 뒤로, <b>걷잡을 수 없는 사건</b>이 기다리고 있었으니…</p>'
    },
    {
      type: 'h2',
      id: 'section8',
    ...
    {
      type: 'body',
      html: '<h3>스포트라이트 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>세상을 바꾼 최강의 팀플레이! </b></span></p>'
    },
    {
      type: 'body',
      html: '<p>미국의 3대 일간지 중 하나인 보스턴 글로브 내 ‘스포트라이트’ 팀은 가톨릭 보스턴 교구 사제들의 아동 성추행 사건을 취재한다. 하지만 사건을 파헤치려 할수록 더욱 굳건히 닫히는 진실의 장벽.</p>'
    },
    {
      type: 'body',
      html: '<p>결코 좌절할 수 없었던 끈질긴 ‘스포트라이트’팀은 추적을 멈추지 않고, 마침내 성스러운 이름 속에 감춰졌던 사제들의 얼굴이 드러나는데…</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>‘스포트라이트’ 팀이 추적한 충격적인 스캔들이 밝혀진다!</b></span></p>'
    },
    {
      type: 'h2',
      id: 'section9',
    ...
    {
      type: 'body',
      html: '<p><b><span style=&quot;background-color: #9feec3;&quot;>진실과 마주한다면 당신은 용서할 수 있는가? </span></b></p>'
    },
    {
      type: 'body',
      html: '<p>연극 ‘세일즈맨의 죽음’을 준비 중인 젊은 부부 ‘라나’와 ‘에마드’. 살고 있던 건물이 붕괴될 위기에 처하자 이전 세입자의 물건들이 남아 있는 기이한 느낌의 아파트로 이사를 간다.</p>'
    },
    {
      type: 'body',
      html: '<p>하지만 남편 \'에마드\'가 집을 비운 어느 날, 그들의 삶이 송두리째 바뀌는 사건이 일어나는데...</p>'
    },
    {
      type: 'h2',
      id: 'section10',
    ...
    {
      type: 'body',
      html: '<h3>천공의 성 라퓨타 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p>광산촌에서 기계 견습공으로 살고 있던 고아 소년 파즈는 어느 날 하늘에서 떨어진 소녀 시타를 구하게 된다.</p>'
    },
    {
      type: 'body',
      html: '<p>시타는 빛나는 목걸이(비행석)로 인해 군대와 해적에게 쫓기고 있었고, 파즈는 그녀와 함께 도망치던 중 라퓨타라는 하늘의 성이 실제로 존재한다는 사실을 알게 된다.</p>'
    },
    {
      type: 'body',
      html: '<p>파즈와 시타는 라퓨타를 찾기로 결심하고, 이를 쫓는 군대와 무스카, 해적 도라 일당과 얽히게 된다.</p>'
    },
    {
      type: 'body',
      html: '<p>파즈는 시타를 구하기 위해 도라 일당에 합류하고, 결국 시타를 구출하지만, 비행석은 무스카에게 빼앗긴다. 군대와 무스카는 라퓨타를 찾아 비행선 골리앗을 타고 추격하고, 파즈와 시타는 도라 일당과 함께 라퓨타를 향해 나선다.</p>'
    },
    {
      type: 'body',
      html: '<p>라퓨타에서 군대의 파괴와 무스카의 음모가 벌어지고, 무스카는 자신이 라퓨타 왕가의 일족임을 밝히며 세계를 지배하려 한다.</p>'
    },
    {
      type: 'body',
      html: '<p><b>결국 시타는 파즈와 함께 파멸의 주문을 외워 라퓨타를 구하려 한다.</b></p>'
    },
    {
      type: 'h2',
      id: 'section11',
    ...
    {
      type: 'body',
      html: '<p>브라질 리오 데자네이로의 중앙역, 산업화에 실패한 도시의 한 구석에서 가난한 사람들의 편지를 대필하며 살아가는 노처녀 도라(페르난다 몬테네그로).</p>'
    },
    {
      type: 'body',
      html: '<p>그녀는 아무런 믿음도 없이 절실한 마음이 담긴 편지를 쓰고 그것들을 쓰레기통에 버린다.</p>'
    },
    {
      type: 'body',
      html: '<p>그런데 그중에는 어린 아들 조슈에(비니시우스 드 올리베이라)를 홀로 키우며 남편을 기다리는 아나의 절박한 편지도 섞여 있었다.</p>'
    },
    {
      type: 'body',
      html: '<p>아나는 편지를 맡긴 후 중앙역 건널목에서 목숨을 잃고, 홀로 남은 조슈에는 도라의 곁에 남게 된다.</p>'
    },
    {
      type: 'body',
      html: '<p>도라는 그를 입양소에 보내지만, 그곳이 아이들의 장기를 팔아넘기는 곳이라는 소문을 듣고 죄책감을 느끼게 된다.</p>'
    },
    {
      type: 'body',
      html: '<p>결국 도라는 조슈에를 빼돌려 아버지를 찾아 함께 떠난다.</p>'
    },
    {
      type: 'h2',
      id: 'section12',
    ...
    {
      type: 'body',
      html: '<h3>파이트 클럽 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p><b><span style=&quot;background-color: #9feec3;&quot;>당신이 알고 있는 모든 것은 허구다!</span> </b></p>'
    },
    {
      type: 'body',
      html: '<p>믿어왔던 상식과 규칙에 통렬한 카운터를 날리는 스타일리시 액션 무비!</p>'
    },
    {
      type: 'body',
      html: '<p>비싼 가구들로 집 안을 채우지만 삶에 강한 공허함을 느끼는 자동차 리콜 심사관 ‘잭’. 거부할 수 없는 매력의 거친 남자 ‘테일러 더든’과의 우연한 만남으로 본능이 이끄는 대로 삶을 살기로 결심한다.</p>'
    },
    {
      type: 'body',
      html: '<p>어느 날, “싸워봐야 너 자신을 알게 된다”라는 테일러 더든의 말에 통쾌한 한 방을 날리는 잭.</p>'
    },
    {
      type: 'body',
      html: '<p>두 사람은 여태껏 경험해보지 못한 강렬한 카타르시스를 느끼며 ‘파이트 클럽’이라는 비밀 조직을 결성하고, 폭력으로 세상에 저항하는 거대한 집단이 형성된다.</p>'
    },
    {
      type: 'body',
      html: '<p>하지만, 걷잡을 수 없이 커진 ‘파이트 클럽’은 시간이 지날수록 의미가 변질되고, 잭과 테일러 더든 사이의 갈등도 점차 깊어져 가는데…</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>거침없는 진짜 남자들의 진짜 싸움이 시작된다!</b></span></p>'
    },
    {
      type: 'h2',
      id: 'section15',
    ...
    {
      type: 'body',
      html: '<h3>판의 미로 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p>1944년 스페인, 내전은 끝났지만 숲으로 숨은 시민군은 여전히 파시스트 정권에 저항하고 있었고, 이를 진압하기 위해 정부군이 곳곳에 배치된다.</p>'
    },
    {
      type: 'body',
      html: '<p>‘오필리아’는 만삭의 엄마 ‘카르멘’과 함께 새아버지 ‘비달’ 대위가 있는 숲 속 기지로 이사를 간다.</p>'
    },
    {
      type: 'body',
      html: '<p>정부군 소속으로 냉정하고 무서운 비달 대위를 비롯해 모든 것이 낯설어 두려움을 느끼던 오필리아는 어느 날 숲 속에서 숨겨진 미로를 발견한다.</p>'
    },
    {
      type: 'body',
      html: '<p>그곳에서 자신을 “산이고 숲이자 땅”이라 소개하는 기괴한 요정 ‘판’을 만나게 된다.</p>'
    },
    {
      type: 'body',
      html: '<p>판은 오필리아에게 그녀가 지하 왕국의 공주 ‘모안나’ 임을 알려주며, 보름달이 뜨기 전까지 세 가지 임무를 마치면 왕국으로 돌아갈 수 있다고 말하며 “선택의 책”을 건넨다.</p>'
    },
    {
      type: 'body',
      html: '<p>전쟁보다 더 무서운 현실 속에서 오필리아는 지하 왕국으로 돌아가기로 결심하고, 용기와 인내, 그리고 마지막 임무를 수행하기 위한 여정이 시작된다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>판의 미로가 다시 열리고, 환상과 현실의 경계가 무너진다!</b></span></p>'
    },
    {
      type: 'h2',
      id: 'section16',
    ...
    {
      type: 'body',
      html: '<p><b><span style=&quot;background-color: #9feec3;&quot;>&quot;박자가 안 맞잖아, 다시!&quot; </span></b></p>'
    },
    {
      type: 'body',
      html: '<p>뉴욕의 명문 셰이퍼 음악학교에서 최고의 스튜디오 밴드에 들어간 신입생 \'앤드류\'.</p>'
    },
    {
      type: 'body',
      html: '<p>최고의 지휘자이지만 동시에 최악의 폭군인 \'플레쳐\' 교수는 폭언과 학대로 \'앤드류\'를 한계까지 몰아붙이고 또 몰아붙인다. 드럼 주위로 뚝뚝 떨어지는 피, 빠르게 달리는 선율 뒤로 아득해지는 의식 속에서, 드럼에 대한 \'앤드류\'의 집착과 광기가 폭발한다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>최고의 연주를 위한 완벽한 스윙이 시작된다!</b></span></p>'
    },
    {
      type: 'body',
      html: '<h3>위플래쉬 리뷰 2부작</h3>'
    },
    {
      type: 'cta',
    ...
    {
      type: 'body',
      html: '<h3>살인의 추억 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p>1986년 경기도, 선을 보러 나갔던 젊은 여인이 배수관에서 발견되며 사건은 시작된다.</p>'
    },
    {
      type: 'body',
      html: '<p>두 달 후, 비슷한 수법의 사건이 연이어 발생하고, 일대는 연쇄적으로 발생한 범죄의 공포에 휩싸인다.</p>'
    },
    {
      type: 'body',
      html: '<p>사건 발생 지역에 특별수사본부가 설치되며, 구희봉 반장(변희봉 역)을 필두로 박두만(송강호 역), 조용구(김뢰하 역), 서태윤(김상경 역) 형사가 투입된다. 박두만은 육감을 믿고 동네 양아치들에게 자백을 강요하며, 서태윤은 사건의 실마리를 찾기 위해 서류를 철저히 검토하지만, 두 사람은 스타일이 달라 처음부터 신경전을 벌인다.</p>'
    },
    {
      type: 'body',
      html: '<p>용의자가 검거되며 사건이 해결될 듯 보이지만, 현장 검증에서 용의자가 범행 사실을 부인하면서 상황은 혼란에 빠지고, 구반장은 파면당한다. 범인은 치밀한 뒤처리로 흔적을 남기지 않으며, 범죄순간마다 피해자의 물품을 이용한다.</p>'
    },
    {
      type: 'body',
      html: '<p>후임으로 신동철 반장(송재호 역)이 부임하며 수사는 활기를 띠기 시작한다.</p>'
    },
    {
      type: 'body',
      html: '<p>박두만은 현장에 아무 흔적도 남기지 않는 범인을 추적하기 위해 절과 목욕탕을 뒤지며 무모증 환자를 찾고, 서태윤은 사건 파일을 검토하던 중 비 오는 날 빨간 옷을 입은 여자가 범행의 주요 대상임을 밝혀낸다.</p>'
    },
    {
      type: 'body',
      html: '<p>형사들은 함정수사를 벌이지만, 다음 날 아침 돌아온 것은 우산이 꽂힌 또 다른 여인의 시체. 사</p>'
    },
    {
      type: 'body',
      html: '<p>건은 다시 미궁에 빠지고, 언론은 형사들의 무능을 비판하며, 형사들은 점점 더 강박증에 시달리게 된다.</p>'
    },
    {
      type: 'h2',
      id: 'section18',
    ...
    {
      type: 'body',
      html: '<h3>팬텀스레드 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p>1950년 런던, 왕실과 사교계의 드레스를 디자인하는 의상실 우드콕의 디자이너 ‘레이놀즈’는 우연히 만난 젊고 당찬 ‘알마’에게 첫눈에 반한다.</p>'
    },
    {
      type: 'body',
      html: '<p>‘레이놀즈’의 인생 최고의 뮤즈이자 유일한 연인이 된 ‘알마’. 마치 환상처럼 화려한 삶을 살아가지만, 그녀는 ‘레이놀즈’가 만든 세상의 일부일 뿐이다.</p>'
    },
    {
      type: 'body',
      html: '<p>그녀는 자신의 전부인 사랑을 걸고 그의 인생을 망치기로 결심한다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>나의 아름다운 뮤즈, 넌 누구일까?</b></span></p>'
    },
    {
      type: 'h2',
      id: 'section19',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>&quot;대가를 치러야지?&quot;</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>성공한 외과 의사 스티븐과 그에게 다가온 소년 마틴. 미스터리한 소년과 친밀해질수록 스티븐과 그의 아내의 이상적인 삶은 점점 더 완벽하게 무너지기 시작한다...</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>&quot;이 악몽을 끝내줘. 할 수 있어?&quot;</b></span></p>'
    },
    {
      type: 'h2',
      id: 'section20',
    ...
    {
      type: 'body',
      html: '<h3>아이리시맨 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p>20세기 미국 정치의 어두운 면과 악명 높은 인물들이 얽힌 사건을 한 남자의 시각으로 풀어낸다.</p>'
    },
    {
      type: 'body',
      html: '<p>장기 미제 사건의 상징인 \'지미 호파 실종 사건\'을 그린 넷플릭스 오리지널 영화</p>'
    },
    {
      type: 'h2',
      id: 'section21',
    ...
    {
      type: 'body',
      html: '<h3>헤어질 결심 줄거리</h3>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>산에서 추락한 남자의 변사 사건을 맡게 된 형사 ‘해준’(박해일). </b></span></p>'
    },
    {
      type: 'body',
      html: '<p>사건의 피해자 아내 ‘서래’(탕웨이)는 남편의 죽음에 대해 특별한 감정을 보이지 않는다.</p>'
    },
    {
      type: 'body',
      html: '<p>‘서래’의 태도에 의심을 품은 경찰은 그녀를 용의 선상에 올리고, ‘해준’은 수사를 통해 서래를 점점 더 알아가며 그녀에게 끌리게 된다. 의심과 호기심이 교차하는 가운데, ‘서래’는 자신을 의심하는 형사 ‘해준’에게도 망설임 없이 다가가는데…</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>진심을 숨긴 용의자와 그를 둘러싼 형사의 미묘한 감정선이 얽히는 &lt;헤어질 결심&gt;</b></span></p>'
    },
    {
      type: 'h2',
      id: 'section22',
    ...
    {
      type: 'body',
      html: '<p>《로마》는 알폰소 쿠아론 감독(《그래비티》, 《칠드런 오브 맨》, 《이 투 마마》)의 어린 시절을 담은 자전적 작품이다.</p>'
    },
    {
      type: 'body',
      html: '<p>멕시코시티의 로마 지역을 배경으로, 이야기는 중산층 가족의 젊은 가정부 클레오(얄리차 아파리시오)의 시선을 따라 전개된다.</p>'
    },
    {
      type: 'body',
      html: '<p>감독 자신을 키운 여성들에 대한 깊은 애정을 담아, 1970년대 멕시코의 정치적 격변 속에서 주인공들이 겪는 가정 내 갈등과 사회적 억압을 사실적으로 그려낸 작품이다.</p>'
    },
    {
      type: 'h2',
      id: 'section23',
