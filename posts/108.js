const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;>명실상부 최고의 영화 평론가로 평가받는 이동진 평론가</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><b>만점없는 평론가 박평식, 그의 평점 9점 영화들</b></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><b>명작은 위스키처럼 익을수록 깊다.</b></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><b>이 포스팅에서 진한 깊이의 명작들을 확인해 보세요.</b></p>'
    },
    {
      type: 'h2',
      id: 'section2',
    ...
    {
      type: 'body',
      html: '<p>아직 평점 표본은 1,000개 미만을 기록하고 있지만, 시작이 좋은 평점을 기록하였습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>평균적으로 7점 초반, 6점 후반대를 자주 볼 수 있는 <span style=&quot;background-color: #9feec3;&quot;><b>IMDB에서 7점 후반은 좋은 성적</b></span>이라고 볼 수 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>평점 분포는 극단으로 나뉘었습니다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>10점이 대부분을 차지하지만 1점이 10%를 차지하며 호불호</b></span>가 갈리는 모습입니다.</p>'
    },
    {
      type: 'body',
      html: '<p><b>평점 국가 표본은 인도네시아, 인도, 미국, 이란, 터키</b> 순입니다.</p>'
    },
    {
      type: 'h2',
      id: 'section3',
      text: '별들에게 물어봐 영어 제목 뜻',
    ...
    {
      type: 'body',
      html: '<p>우주라는 거대한 배경을 설정으로, <b>각기 다른 인물들의 이야기가 얽히고설키며 벌어지는 상황을 표현하려는 의도</b>가 담겨 있을 가능성이 큽니다. <b>&quot;별&quot;은 일반적으로 우주와 연결</b>되는 상징적 요소이기도 하고,<b> &quot;소문&quot;이라는 단어가 들어가면서 이야기가 사람들 간의 대화나 전해지는 이야기처럼 전개</b>될 것임을 암시할 수 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>우주의 크기와 미스터리, 그리고 <b>등장인물들 간의 상호작용과 이야기의 흐름을 묘사하려는 목적</b>을 지닌 제목이라고 볼 수 있겠네요.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section4',
      text: '별들에게 물어봐 해외 리뷰 후기',
    ...
    {
      type: 'body',
      html: '<p>1화 2화에 대한 어느정도의 스포가 포함되어 있을 수 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>이점 확인하시고 내용을 보시길 바랍니다.</p>'
    },
    {
      type: 'h2',
      id: 'section5',
      text: '놀라운 시작 - 평점 10/10',
    ...
    {
      type: 'body',
      html: '<p>새로운 이야기이지만 급하게 진행하지 않고, 제대로 발전시켰으며 <b>최근의 유행을 최대한 활용하려 하지 않았습니다.</b></p>'
    },
    {
      type: 'body',
      html: '<p>한국 드라마가 <b>종종 반쯤 익혀서 나오는 경우가 많지만, 이 드라마는 정말 훌륭한 시작</b>을 보여주네요.</p>'
    },
    {
      type: 'body',
      html: '<p>앞으로의 전개가 매우 기대됩니다.</p>'
    },
    {
      type: 'h2',
      id: 'section6',
      text: '우주에서 펼쳐지는 유머 가득하고 굉장한 드라마!- 평점 10/10',
    ...
    {
      type: 'body',
      html: '<p><b>이민호 배우가 헌신적인 의사이자 우주 비행사 역할</b>을 맡은 것이 너무 좋아요.</p>'
    },
    {
      type: 'body',
      html: '<p>Eve 사령관은 정말 사랑스럽습니다!</p>'
    },
    {
      type: 'body',
      html: '<p>모든 장면이 긴장감 넘치면서도, 마지막 결말에 대해 궁금하게 만드는 많은 정보를 줍니다.</p>'
    },
    {
      type: 'body',
      html: '<p><b>결말이 어떻게 될지 궁금해지는 그런 느낌을 좋아합니다.</b></p>'
    },
    {
      type: 'body',
      html: '<p>심각한 주제를 다루면서도 재미있는 장면들이 많습니다. 여러 장면에서 심각하게 볼 수도 있고, 웃긴 부분으로 볼 수도 있죠! 감독이 잘 풀어낸 부분이 마음에 듭니다.</p>'
    },
    {
      type: 'body',
      html: '<blockquote><span style=&quot;color: #781b33;&quot;><b><span style=&quot;font-family: \'Noto Serif KR\';&quot;>최근에 이렇게 시청자에게 <br/>시각적인 즐거움을 선사하기 위해 <br/>노력하는 드라마를 본 적이 없어요.</span> </b></span></blockquote>'
    },
    {
      type: 'body',
      html: '<p><b>발사 장면, 하늘, 지구, 지구와 우주의 팀들이 정말 잘 만들어졌습니다!</b></p>'
    },
    {
      type: 'body',
      html: '<p>우주 정거장은 매우 현실감 있게 그려졌고, 그곳에서의 연기도 훌륭합니다.</p>'
    },
    {
      type: 'body',
      html: '<p>정말 기대되는 캐스트입니다!</p>'
    },
    {
      type: 'h2',
      id: 'section7',
      text: '놀라운 시리즈 - 평점 10/10',
    ...
    {
      type: 'body',
      html: '<p>많은 사람들이 몇 년 동안 기다려온 작품이라, <b>기다린 만큼 값진 드라마</b>라고 할 수 있습니다. 이민호는 그의 자연스러운 코미디 타이밍과 완벽한 표정으로 내 관심을 끌었습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>그의 거의 모든 작품을 봤고, 그는 장르를 넘어서는 뛰어난 재능을 지닌 몇 안 되는 한국 배우 중 한 명이라고 생각합니다. Gong Ryong 역할을 정말 잘 소화해내고 있어요. 앞으로의 에피소드가 정말 기대됩니다.</p>'
    },
    {
      type: 'h2',
      id: 'section8',
      text: '우주에서의 K드라마 클리셰 - 평점 4/10',
      gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>이 드라마는 그저 우주 배경에 맞춰서 전형적인 K-드라마가 되어버렸습니다. 설정만 바뀌었을 뿐, 내용이나 이야기는 전혀 변화가 없습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>이런 쇼를 보는 사람들은 스토리나 플롯에 신경 쓰지 않아요.</p>'
    },
    {
      type: 'body',
      html: '<p>그저 새로운 포장지로 싸서 나오는 똑같은 이야기를 좋아하는 사람들이죠.</p>'
    },
    {
      type: 'body',
      html: '<p>똑똑하거나 지능적인 무언가를 기대하지 마세요. 우주는 그냥 전형적인 K-드라마의 사랑 삼각형과 천재 억만장자의 배경일 뿐이에요. 정말 예측할 수 있었던 부분입니다 😉</p>'
    },
    {
      type: 'h2',
      id: 'section9',
      text: '이민호! 이민호! 이민호!- 평점 9/10',
      gradientStyle: 'linear-gradient(to right, #6a1b9a, #ab47bc)'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<blockquote><span style=&quot;color: #781b33;&quot;><b><span style=&quot;font-family: \'Noto Serif KR\';&quot;>이 작품은 걸작이 될 것 같은 <br/>긍정적인 느낌을 주네요.</span></b></span></blockquote>'
    },
    {
      type: 'body',
      html: '<p>이상으로 드라마 별들에게 물어봐 관람평 결말후기 포스팅 마칩니다.</p>'
    },
    {
      type: 'ending',
      html: '<p>감사합니다.</p>'
