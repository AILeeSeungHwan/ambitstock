const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post74_thumb.svg',
      alt: '포풍추영 관람평 모아보기 | 해외 평론가 반응·결말 후기·평가 정리 중국 홍콩영화 추천',
      caption: '포풍추영 관람평 모아보기 | 해외 평론가 반응·결말 후기·평가 정리 중국 홍콩영화 추천'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p>관객 평가는 대체로 <b>성룡의 부활, 양가휘의 빌런 연기, 준의 신선한 캐릭터</b>가 긍정적 평가를 받았으며, 일부는 <b>스토리 전개의 빈틈</b>을 아쉬워했습니다. 특히 일반관객의 평점은 로튼 토마토기준 무려 98%를 기록하며 굉장히 긍정적인 평가를 받고 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>이러한 관객 평가만으로도 영화관에서 봐야할 이유를 제공해 줍니다.</p>'
    },
    {
      type: 'h2',
      id: 'section3',
    ...
    {
      type: 'body',
      html: '<p>저는 개인적으로 성룡이 세월과 함께 어떤 방식으로 무대 위에 다시 서는지 보여주는 <b>배우 인생의 전환점</b>이라고 생각합니다.</p>'
    },
    {
      type: 'body',
      html: '<p>지금 이 영화를 볼 수 있다는 사실만으로도 한 편의 시대를 경험하는 기분이 듭니다.</p>'
    },
    {
      type: 'h2',
      id: 'section5',
