const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: '<p>두 플랫폼을 모두 이용 중인데, 개인적으로 느낀 차이는 이렇습니다. 넷플릭스는 <b>콘텐츠 업데이트 속도와 추천 알고리즘</b>이 강점이에요. 반면 디즈니플러스는 <b>영상 품질과 사운드</b>가 확실히 좋습니다. 가족 단위 이용자라면 디즈니가, 드라마·다큐 위주 시청자라면 넷플릭스가 낫다는 게 제 결론이에요.</p>'
    },
    {
      type: 'h2',
      id: 'section6',
