const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '에일리언 로물루스 로튼 토마토 및 IMDB 평점', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: '에일리언 로물루스 평론가 결말 후기 관람평', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
