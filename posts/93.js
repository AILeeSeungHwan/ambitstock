const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post93_thumb.svg',
      alt: '퇴마록 개봉 결말 후기 관람평 뜻 해석 평점 < 오컬트 애니메이션 영화 2부후속편 기대 >',
      caption: '퇴마록 개봉 결말 후기 관람평 뜻 해석 평점 < 오컬트 애니메이션 영화 2부후속편 기대 >'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p>해동밀교의 다섯 호법들은 그를 막기 위해 힘을 보태줄 새로운 인물을 찾아 나서고,</p>'
    },
    {
      type: 'body',
      html: '<p>파문당한 신부 박윤규, 무공을 위해 밀교를 찾은 현암,</p>'
    },
    {
      type: 'body',
      html: '<p>사건의 중심에 있는 예언의 아이 준후가 합세해 거대한 악에 맞서는데...</p>'
    },
    {
      type: 'body',
      html: '<blockquote><span style=&quot;color: #781b33;&quot;><b><span style=&quot;font-family: \'Noto Serif KR\';&quot;>하늘이 불타던 날, <br/>새로운 전설이 시작된다!</span></b></span></blockquote>'
    },
    {
      type: 'h2',
      id: 'section3',
    ...
    {
      type: 'body',
      html: '<p><b>록(錄)</b>: \'록(錄)\'은 기록, 연대기, 문서 등을 의미합니다. 즉, 어떤 사건이나 이야기를 기록한 문서를 뜻하는 경우가 많습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>따라서 \'퇴마록\'이라는 제목은 \'악령을 쫓아내는 이야기의 기록\'이라는 뜻을 가지며, 퇴마사들이 초자연적인 존재와 싸우는 사건을 다룬 작품이라는 것을 제목만으로도 알 수 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>원작 소설과 영화는 이러한 개념을 바탕으로, 다양한 신화와 종교적 요소를 결합하여 퇴마사들이 벌이는 신비로운 이야기들을 담고 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<div><center><a href=&quot;https://www.imdb.com/title/tt32341853/?ref_=fn_all_ttl_1&quot; title=&quot;영화 퇴마록 해외 평점은?&quot;><button class=&quot;btn-hover color-8&quot;> 해외 평점 보러 가기 👉</button></a></center></div>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><b>영화 퇴마록 평점이 궁금하시다면??</b></p>'
    },
    {
      type: 'body',
      html: '<div><center><a href=&quot;https://search.naver.com/search.naver?where=nexearch&amp;sm=tab_etc&amp;mra=bkEw&amp;pkid=68&amp;os=34316803&amp;qvt=0&amp;query=영화%20퇴마록%20상영일정&quot; title=&quot;영화 퇴마록 보러가기&quot;><button class=&quot;btn-hover color-8&quot;>영화 퇴마록 바로 보러 가기👉</button></a></center></div>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<h3>1. GGV 명동씨네라이브러리 시사회 (2025년 2월 7일)</h3>'
    },
    {
      type: 'body',
      html: '<p>이 시사회에는 원작자 이우혁 작가가 참석하여 팬사인회도 진행되었습니다. 참석자들은 영화가 원작의 감성을 잘 살려냈으며, 동서양의 다양한 종교와 신화를 결합한 화려한 비주얼과 액션이 인상적이었다고 평가했습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>특히, 3D 카툰 렌더링 기법을 통해 독특한 작화가 돋보였다는 의견이 있었습니다.  </p>'
    },
    {
      type: 'body',
      html: '<h3>2. 더쿠 커뮤니티 시사회 후기</h3>'
    },
    {
      type: 'body',
      html: '<p>한 더쿠 회원은 시사회 참석 후, 영화가 오랜 기다림을 보상해 줄 만큼 잘 만들어졌으며, 한국적인 분위기가 잘 녹아들어 감동적이었다고 전했습니다. 또한, 상상만 했던 능력들이 영상으로 구현된 것이 인상적이었으며, 다음 편에 대한 기대감을 나타냈습니다.</p>'
    },
    {
      type: 'body',
      html: '<h3>3. 루리웹 커뮤니티 시사회 후기</h3>'
    },
    {
      type: 'body',
      html: '<p>루리웹의 한 회원은 영화의 공포와 오컬트 요소가 적절히 조화되어 재미있었다고 평가했습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>특히, 몇몇 장면은 영화관에서만 느낄 수 있는 몰입감을 제공하여 여러 번 관람하고 싶다는 의견을 남겼습니다.</p>'
    },
    {
      type: 'body',
      html: '<h3>4. 인스타그램 후기</h3>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>전반적으로, \'퇴마록\'은 원작의 감성을 충실히 재현하면서도 독특한 비주얼과 액션으로 관객들의 호평을 받고 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>특히, 특화된 상영관에서의 관람이 영화의 매력을 한층 더 높여준다는 평가가 많습니다.</p>'
    },
    {
      type: 'ending',
      html: '<div><center><a href=&quot;https://search.naver.com/search.naver?where=nexearch&amp;sm=tab_etc&amp;mra=bkEw&amp;pkid=68&amp;os=34316803&amp;qvt=0&amp;query=영화%20퇴마록%20상영일정&quot; title=&quot;영화 퇴마록 보러가기&quot;><button class=&quot;btn-hover color-8&quot;>영화 퇴마록 바로 보러 가기👉</button></a></center></div>'
