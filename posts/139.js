const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><a href=&quot;/ rel=&quot;noopener&quot; title=&quot;오징어 게임 시즌 1 해외 반응&quot;>오징어게임 1 해외 반응</a></p>'
    },
    {
      type: 'cta',
      href: '/',
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>시즌 후반부에서는 참가자들이 남은 마지막 두 게임을 치르며 극한의 상황에 처하게 됩니다.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>마지막 게임에서는 기훈과 프론트맨의 대결이 절정에 달하며, 이 과정에서 기훈은 자신이 중요하게 여기는 가치와 생존 사이에서 갈등하게 됩니다. 결말에서는 프론트맨과의 대립이 일단락되지만, <b>게임의 설계자인 VIP 세력과 그들의 전 세계적인 영향력</b>이 드러나며 새로운 갈등의 씨앗이 뿌려집니다. 성기훈은 이 조직을 완전히 무너뜨리기 위해 끝까지 싸울 것을 다짐하며 시즌 3의 서막을 알립니다.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>시즌 2는 시즌 1에서 제기된 많은 떡밥들을 회수하며, 게임의 배경과 구조를 더 깊이 파고들어 이야기를 확장시킵니다.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>시즌 내내 숨 막히는 긴장감과 예상치 못한 반전들이 이어지며, 시청자들에게 강렬한 몰입감을 선사합니다.</p>'
    },
    {
      type: 'h2',
      id: 'section5',
