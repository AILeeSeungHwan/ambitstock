const post = {
  ...
  sections: [
    ...
    {
      type: 'intro',
      html: '<p>이동진 평론가가 평점 만점을 준 작품에서 찾은 볼만한 넷플릭스 영화 추천 작품들입니다.</p><p>인생 영화들로 구성된 리스트들은 <span style=&quot;background-color: #01ff51;&quot;><b>모두 넷플릭스에서 시청 가능한 작품</b></span>들입니다.</p><p><figure class=&quot;imageblock widthContent&quot; data-origin-height=&quot;962&quot; data-origin-width=&quot;986&quot;><span data-alt=&quot;볼만한 넷플릭스 인생영화 추천&quot; data-phocus=&quot;https://blog.kakaocdn.net/dna/bIakz0/btsIPM6pjtO/AAAAAAAAAAAAAAAAAAAAAHE1hzmd987DivafNoRMe9Cg-k9qWnEyl3qZclTyuRiH/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=UbaL%2FBN5l9XR%2Fi8BgANDZst0FaE%3D&quot; data-url=&quot;https://blog.kakaocdn.net/dna/bIakz0/btsIPM6pjtO/AAAAAAAAAAAAAAAAAAAAAHE1hzmd987DivafNoRMe9Cg-k9qWnEyl3qZclTyuRiH/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=UbaL%2FBN5l9XR%2Fi8BgANDZst0FaE%3D&quot;></span><figcaption>볼만한 넷플릭스 인생영화 추천</figcaption> </figure> </p>'
    },
    {
      type: 'image',
      src: '/images/post380_thumb.svg',
      alt: '넷플릭스 영화 추천 | 이동진 평론가 평점 만점작에서 찾는 인생영화 - 넷플릭스 시청가능 수상작품',
      caption: '넷플릭스 영화 추천 | 이동진 평론가 평점 만점작에서 찾는 인생영화 - 넷플릭스 시청가능 수상작품'
    },
    { type: 'toc' },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><span style=&quot;background-color: #f3c000;&quot;><b>추천하고 싶은 </b><b>본인의 인생영화를 댓글로 남겨주세요.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;><span style=&quot;background-color: #f3c000;&quot;><b>해당 영화의 해외 평론가 평점 포스팅을 전해드립니다.</b></span></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>나치의 만행이 극에 달했던 1944년, 아우슈비츠 수용소에는 시체들을 처리하기 위한 비밀 작업반이 있었다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>처리해야 할 시체더미들 사이에서 아들을 빼낸 \'사울\'은</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #01ff51;&quot;><b>“당신이 알고 있는 모든 것은 허구다!&quot;</b></span></p>'
    },
    {
      type: 'body',
      html: '<p><br/>비싼 가구들로 집 안을 채우지만 삶에 깊은 공허함을 느끼는 자동차 리콜 심사관 ‘잭’.</p>'
    },
    {
      type: 'body',
      html: '<p>우연히 만난 거칠고 매력적인 남자 ‘테일러 더든’과의 만남을 계기로 본능이 이끄는 대로 삶을 살기로 결심한다.</p>'
    },
    {
      type: 'body',
      html: '<p>어느 날, “싸워봐야 네 자신을 알게 된다”는 테일러의 말에 따라 통쾌한 한 방을 날린 잭.<br/><span style=&quot;background-color: #01ff51;&quot;><b>두 사람은 경험해보지 못한 강렬한 카타르시스</b><b>를 느끼며 ‘파이트 클럽’이라는 비밀 조직을 결성</b></span>하고,<br/>폭력으로 세상에 저항하는 거대한 집단이 형성된다.</p>'
    },
    {
      type: 'body',
      html: '<p>그러나 시간이 지날수록 ‘파이트 클럽’은 그 의미가 변질되고, 잭과 테일러의 갈등은 깊어져 가는데…</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #01ff51;&quot;><b>거침없는 진짜 남자들의 진짜 싸움이 시작된다!</b></span></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #01ff51;&quot;><b>“후회하지 말고 기억해”</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>초상화를 그리는 화가 마리안느(노에미 멜랑)는 원치 않는 결혼을 앞둔 귀족 아가씨 엘로이즈(아델 에넬)에게 결혼 초상화를 의뢰받는다.</p>'
    },
    {
      type: 'body',
      html: '<p>엘로이즈가 모르게 그림을 완성해야 하는 마리안느는 비밀스럽게 그녀를 관찰하며 묘한 감정의 기류에 휩싸이게 된다.</p>'
    },
    {
      type: 'body',
      html: '<p>잊을 수 없는, 잊혀지지 않을</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #01ff51;&quot;><b>사랑의 기억을 마주하게 되는 걸작을 만난다.</b></span></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #01ff51;&quot;><b>&quot;시x, 내 템포에 맞추라고!!&quot;</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>뉴욕의 명문 셰이퍼 음악학교에서 최고의 스튜디오 밴드에 들어가게 된 신입생 앤드류.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>드럼 위로 뚝뚝 떨어지는 피, 빠르게 달리는 선율 뒤로 아득해지는 의식,</p>'
    },
    {
      type: 'body',
      html: '<p>그 순간, 드럼에 대한 앤드류의 집착과 광기가 폭발한다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #f3c000;&quot;><b>1986년 경기도. 젊은 여인이 무참히 강간, 살해당한 시체로 발견된다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>2개월 후 비슷한 수법의 강간살인 사건이 연이어 발생하면서 사건은 세간의 주목을 받기 시작하고,</p>'
    },
    {
      type: 'body',
      html: '<p>일대는 연쇄살인이라는 생소한 범죄의 공포에 휩싸인다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #01ff51;&quot;><b>육감과 폭력으로 수사를 진행하는 박 형사와 증거와 과학 수사를 추구하는 서 형사는 수사 내내 마찰</b></span>을 일으키는데...</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #f3c000;&quot;><b>내 사랑이 널 완성할거야. </b></span></p>'
    },
    {
      type: 'body',
      html: '<p>1950년 런던. 왕실과 사교계의 드레스를 만드는 의상실 우드콕의 디자이너 ‘레이놀즈’는 우연히 마주친 젊고 당찬 ‘알마’에게 첫눈에 반한다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>마치 환상처럼 화려한 인생을 살고 있지만,</p>'
    },
    {
      type: 'body',
      html: '<p>레이놀즈가 만든 세상의 일부일 뿐인 그녀는 자신의 전부인 사랑을 걸고 그의 인생을 망치기로 한다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>성공한 외과 의사 스티븐과 그에게 다가온 소년 마틴.</p>'
    },
    {
      type: 'body',
      html: '<p>미스터리한 그와 친밀해질수록 스티븐과 그의 아내의 이상적인 삶은 완벽하게 무너지는데...</p>'
    },
    {
      type: 'body',
