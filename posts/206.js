const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><span style=&quot;background-color: #9feec3;&quot;><b>미스터 플랑크톤 제목 뜻 의미 해석입니다.</b></span></p>'
    },
    ...
    {
      type: 'body',
      html: '<p>한국 드라마 <i>미스터 플랑크톤</i>은 주인공이 마치 플랑크톤처럼 자기 의지와 상관없이 삶의 흐름에 휩쓸리는 인물을 중심으로 한 이야기입니다.</p>'
    },
    {
      type: 'body',
      html: '<p>플랑크톤은 자신의 힘으로는 이동하지 못하고 바다의 흐름에 따라 떠다니며 살아가는 생명체인데, 이와 같이 <span style=&quot;background-color: #9feec3;&quot;><b>주인공도 스스로 결정하기보다는 주어진 환경과 상황에 따라 살아가야 하는 인생을 상징적으로 표현</b></span>하고 있습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>드라마는 주인공이 외부 상황에 휘둘리면서도 자신만의 삶의 방향을 찾기 위해 노력하는 여정을 다루며, 그 과정에서 성장과 내면의 변화, 정체성을 찾아가는 모습을 담고 있습니다.</p>'
    },
    {
      type: 'h2',
      id: 'section3',
      text: '미스터 플랑크톤 로튼토마토 평론가 평점',
      gradientStyle: 'linear-gradient(to right, #6a1b9a, #ab47bc)'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><span style=&quot;background-color: #9feec3;&quot;><b>미스터 플랑크톤 평론가 평점입니다.</b></span></p>'
    },
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>아직은 로튼토마토에서는 평점을 확인할 수 없습니다.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>빠른 시일 내에 평점이 기록되면 업데이트하겠습니다.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section4',
      text: '미스터 플랑크톤 평점 인기 순위',
      gradientStyle: 'linear-gradient(to right, #e53935, #ef5350)'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><span style=&quot;background-color: #9feec3;&quot;><b>미스터 플랑크톤 인기 순위 및 평점입니다.</b></span></p>'
    },
    { type: 'image', src: '/images/post206_img4.jpg', alt: '미스터 플랑크톤 평점', caption: 'ⓒ R의 필름공장' },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><span style=&quot;background-color: #f3c000;&quot;><b>IMDB 평점은 8.2점, 인기순위는 726위입니다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>IMDB에서의 평점 8.2점은 굉장히 의미가 큰 바로, 높은 점수를 의미합니다.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>IMDB에서 시청자, 관객 점수는 다양한 분포를 띄고, 또한 일부로 평점 1점을 주는 평점테러의 영향으로 8점 이상의 점수는 나오기 쉽지 않습니다.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>해당 점수는 IMDB 내에서도 상당히 높은 점수이므로, 기대 이상의 평점을 기록하였음을 알 수 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>인기 순위 또한 공개 후 2,947위나 상승하며 높은 인기순위를 이어가고 있습니다.</p>'
    },
    {
      type: 'h2',
      id: 'section5',
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><span style=&quot;background-color: #9feec3;&quot;><b>미스터 플랑크톤 평점 분포 살펴보겠습니다.</b></span></p>'
    },
    { type: 'image', src: '/images/post206_img6.jpg', alt: '미스터 플랑크톤', caption: 'ⓒ R의 필름공장' },
    { type: 'image', src: '/images/post206_img5.jpg', alt: '미스터 플랑크톤', caption: 'ⓒ R의 필름공장' },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>총 표본 수는 약 천 개이며, 전체적으로 높은 평점대를 형성하고 있음을 알 수 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>평점표본 국가는 미국 인도 영국 터키 독일 순입니다.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><span style=&quot;background-color: #9feec3;&quot;><b>무려 10점의 비율이 50.6%로 압도적인 만족도를 보이고 있고, 6점 아래 평점도 모두 합쳐도 10%가 안 되는 좋은 평가를 기록하였습니다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>그렇다면 도대체 어떠한 부분이 해외 시청자들의 마음을 사로잡았을까요.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>다음 포스팅에서 미스터 플랑크톤 해외 시청자 후기반응 리뷰 살펴보겠습니다.</p>'
    },
    {
      type: 'body',
