const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post345_thumb.svg',
      alt: '넷플릭스 인기 순위 더 인플루언서 과즙세연 오킹 근황 이슈논란 속 1위 유지',
      caption: '넷플릭스 인기 순위 더 인플루언서 과즙세연 오킹 근황 이슈논란 속 1위 유지'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p>이어진 네 번째 라운드에서는 인플루언서들의 다양한 자질을 평가하는 4개의 게임이 진행되었습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>이 과정에서 생존자들은 메타 인지 능력, 파급력, 설득력, 콘텐츠 분석력을 증명하며 치열한 경쟁을 펼쳤습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>최종 라운드는 생존자 TOP 4가 자신의 매력과 영향력을 보여주는 팝업 스테이지로 진행되었고, 500명의 현장 판정단을 통하여 승자를 결정했습니다. <span style=&quot;background-color: #9feec3;&quot;><b>장지수, 오킹, 빠니보틀, 이사배 4인의 생존자 중 최종 우승자는 방송 전부터 알려져 있 듯, 오킹</b></span>이 되었습니다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>넷플릭스 더 인플루언서 논란과 이슈입니다.</b></span></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>프로그램은 시작 전부터 오킹과 관련된 논란, 출연자 과즙세연으로 인해 주목을 받기도 했습니다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>현재 오킹은 여전히 위너즈 측과 법적분쟁에 있으며, 유튜브 영상 업로드 또한 하지 않고 있고, 미국에서 포착된 사진으로 인해 화제가 된 아프리카 TV BJ 과즙세연 또한 악성 게시물 및 댓글에 법적 대응을 하겠다고 밝혔습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>13일 아프리카TV 홈페이지에 게시된 과즙세연 법적 대응 예고입니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>이미 프로그램이 시작되기 전 부터 우승자가 공개되며 전국민 강제(?) 스포를 당하게 된 더 인플루언서.</p>'
    },
    {
      type: 'body',
