const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: '<p>&quot;Blink Twice&quot;는 직역하면 &quot;두 번 깜빡이다&quot;로 해석될 수 있으며,</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #f3c000;&quot;><b>보통 위험이나 의심스러운 상황에서 무언가의 진실을 감지하거나 이중적 의미를 발견할 때 사용되는 표현</b></span>입니다.</p>'
    },
    {
      type: 'body',
      html: '<p>영화는 <span style=&quot;background-color: #f3c000;&quot;><b>주인공이 겪는 상황에서 진실과 거짓을 구분하는 데 필요한 순간적 판단이나 직감의 중요성을 강조</b></span>합니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>영화가 다루는 주제, 즉 현실에서 겪는 불안과 혼란 속에서 무엇이 진짜이고 무엇이 허상인지를 두려움과 함께 알아가야 한다는 의미를 내포하고 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>또한, 두 번 깜빡이는 순간에 숨겨진 비밀이나 결정적인 단서가 드러날 수 있다는 상징적 의미도 포함되어 있어 영화 속 반전과 긴장감을 잘 전달하는 표현으로 볼 수 있습니다.</p>'
    },
    {
      type: 'h2',
      id: 'section2',
      text: '블링크 트와이스 로튼토마토 평론가 평점',
