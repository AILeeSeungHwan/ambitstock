const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post61_thumb.svg',
      alt: '넷플릭스 요금제 할인 총정리 2025년 - 통신사 카드 혜택',
      caption: '넷플릭스 요금제 할인 총정리 2025년 - 통신사 카드 혜택'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p>실제 제 지인은 KT 인터넷 결합 상품을 쓰면서 넷플릭스를 추가 비용 없이 보고 있어요. 원래 따로 프리미엄(17,000원)을 내고 있었는데, 지금은 월 0원으로 해결되니 체감 만족도가 굉장히 높다고 하더라고요.</p>'
    },
    {
      type: 'body',
      html: '<h3>② 카드사 혜택</h3>'
    ...
    {
      type: 'body',
      html: '<ul style=&quot;list-style-type: disc;&quot;> <li><b>국민카드</b> : 문화 구독 서비스 월 2회 이상 결제 시 5천 원 캐시백</li> <li><b>현대카드</b> : OTT 정기결제 10% M포인트 적립</li> <li><b>삼성카드</b> : 디지털 구독 서비스 통합 결제 시 월 최대 1만 원 할인</li> </ul>'
    },
    {
      type: 'body',
      html: '<p>저는 국민카드 캐시백을 활용하는데, 매달 5천 원씩만 돌려받아도 1년이면 6만 원 절약이에요. 주변에선 현대카드 M포인트를 활용해 포인트로 구독료를 거의 전액 커버하는 분도 있더군요.</p>'
    },
    {
      type: 'body',
      html: '<h3>③ 계정 공유 (가족 그룹)</h3>'
    },
    {
      type: 'body',
      html: '<p>넷플릭스는 계정 공유 제한을 강화했지만, 같은 가구 내 가족 인증을 하면 여전히 나눠 쓸 수 있습니다. 프리미엄 요금제(17,000원)를 4명이 나눠 쓰면 1인당 월 4,250원 수준이 됩니다. 제 후배는 가족끼리 계정을 나눠서 쓰는데, 본인 부담은 월 4천 원 정도라 “OTT 중 가장 가성비가 좋다”고 하더라고요.</p>'
    },
    {
      type: 'cta',
    ...
    {
      type: 'body',
      html: '<h3>④ 연간 결제·플랫폼 할인</h3>'
    },
    {
      type: 'body',
      html: '<p>넷플릭스는 자체 연간 결제 할인은 없지만, 일부 통신사나 카드사 이벤트에서 <b>12개월 선결제 시 1개월 무료</b> 같은 혜택을 제공하기도 합니다. 또 구글플레이·애플 앱스토어 결제보다 웹 결제가 보통 더 저렴하니, <b>결제 경로만 바꿔도 절약</b>이 가능해요.</p>'
    },
    {
      type: 'body',
      html: '<h3>⑤ 주변 사례</h3>'
    ...
    {
      type: 'body',
      html: '<p>제 친구 중 한 명은 LG U+ 인터넷을 쓰면서, 삼성카드 할인까지 적용해 한 달에 약 12,000원 수준으로 프리미엄 요금제를 이용 중이에요. 또 다른 지인은 가족 4명이 프리미엄을 나눠 쓰고, 국민카드 캐시백까지 받아서 실제 부담은 월 3천 원대에 불과하다고 했습니다. OTT 구독료가 부담스러운 시대에, 이런 ‘조합 전략’이 진짜 효과가 크더군요.</p>'
    },
    {
      type: 'h2',
      id: 'section2',
    ...
    {
      type: 'body',
      html: '<p>주변에서도 이미 이렇게 쓰는 경우가 많으니, 지금 본인 상황에 맞게 조합을 찾아보시면 좋을 것 같아요.</p>'
    },
    {
      type: 'h2',
      id: 'section3',
