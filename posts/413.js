const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post413_thumb.svg',
      alt: '스위트 홈 시즌3 공개일 임박! 넷플릭스 시리즈 이전 줄거리 요약 등장인물 티저 예고편',
      caption: '스위트 홈 시즌3 공개일 임박! 넷플릭스 시리즈 이전 줄거리 요약 등장인물 티저 예고편'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;font-family: \'Noto Serif KR\';&quot;>넷플릭스 시리즈 &quot;스위트홈&quot; 시즌 3는 시즌 2의 클리프행어에서 이어지며, 시즌 2에서 살아남은 캐릭터들이 모두 돌아옵니다. 차현수(송강 분)는 여전히 몬스터로 변하지 않기 위해 싸우고 있으며, 서이경(이시영 분)은 인간성과 몬스터의 경계에서 고군분투합니다. 정의명(이진욱 분)은 인간을 몬스터로 변하게 하는 방법을 찾으려 하며, 이은혁(이도현 분)은 그린 홈 아파트 붕괴에서 생존하여 돌아옵니다. </span></p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;font-family: \'Noto Serif KR\';&quot;>시즌 3에서는 이들 캐릭터가 직면한 여러 미스터리를 풀고, 새로운 생존자들과의 갈등을 다루게 됩니다. 시즌 2에서는 서이경의 아이가 몬스터와 인간의 혼혈로 특별한 능력을 가지고 태어났으며, 인간처럼 보이는 몬스터들이 그린 홈에서 출현합니다. 시즌 3에서는 이러한 요소들이 어떻게 발전할지, 그리고 서이경과 아이의 관계가 어떻게 전개될지 궁금증을 자아냅니다.</span></p>'
    },
    {
      type: 'body',
      html: '<p><b><span style=&quot;font-family: \'Noto Serif KR\';&quot;>주요 캐릭터 및 출연진</span></b></p>'
    },
    {
      type: 'body',
      html: '<p><figure><figcaption>넷플릭스 시리즈 스위트홈 송강</figcaption> </figure> </p>'
