const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '싱글 에이트 IMDB 평점 및 인기 순위', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'body', html: "<p>심사위원대상을 받은 작품이라는 평에 비하여 높지 않은 평점을 기록 중에 있습니다.</p>" },
    { type: 'body', html: "<p>아직 로튼 토마토에서의 평점은 존재하지 않기 때문에, 로튼 토마토 평점 및 후기 집계시 다음 포스팅에서 다뤄보도록 하겠습니다.</p>" },
    { type: 'h2', id: 'section2', text: '싱글 에이트 평점 분포 분석', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
    { type: 'image', src: "/images/post254_img3.jpg", alt: "싱글 에이트 평점분포", caption: "ⓒ R의 필름공장" },
    { type: 'body', html: "<p><span style=&quot;background-color: #f3c000;&quot;><b>총 표본 수는 183개이며, 예상대로 7점에 가장 많은 평점분포를 이루고 있습니다.</b></span></p>" },
    { type: 'body', html: "<p>전체적으로 높은 점수는 아니지만, 무난하게 좋은 점수를 받은 모습입니다.</p>" },
    { type: 'body', html: "<p>국가 표본은 특이하게 일본영화임에도 중국 표본이 가장 높으며, 미국 호주 영국 헝가리 순으로 집계되었습니다.</p>" },
    { type: 'h2', id: 'section3', text: '싱글 에이트 제목 뜻 — 8mm 필름과 성장의 의미', gradientStyle: 'linear-gradient(to right, #6a1b9a, #ab47bc)' },
