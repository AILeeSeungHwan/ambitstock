const post = {
  ...
  sections: [
    ...
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section1',
      text: '미키 17 관람평 정보 시사회 해외 반응 후기 포토',
    ...
    {
      type: 'body',
      html: '<p>하지만 할리우드 파업이후 미뤄진 개봉일이 이번에도 미뤄지게 되었습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>이번에 결정된 미키 17의 개봉일은 언제인지,</p>'
    },
    {
      type: 'body',
      html: '<p>미키 17의 개봉일이 또 한 번 미루어지게 된 이유를 비공개 시사회 해외 반응을 바탕으로 알아보도록 하겠습니다.</p>'
    },
    {
      type: 'h2',
      id: 'section2',
    ...
    {
      type: 'body',
      html: '<p>또 다른 참석자는 &quot;마크 러팔로는 극 중에서 유머러스하면서도 강렬한 존재감을 보여주며, 그의 연기는 <i>\'설국열차\'</i>에서 틸다 스윈튼의 독특한 캐릭터를 연상시킨다. 봉 감독의 작품답게 배우들의 연기가 영화의 큰 강점으로 작용했다.&quot;라고 평가했습니다.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section4',
      text: '미키 17 시사회 해외 관람평 부정적 반응',
    ...
    {
      type: 'body',
      html: '<p>한 관계자는 &quot;내부 시사에서 간부들의 반응이 기대에 못 미쳤다. 영화의 철학적 주제와 독특한 전개 방식이 대중성 면에서는 약간의 한계를 가질 수도 있다는 의견이 있었다.&quot;라고 전했습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>이에 따라 영화의 개봉 일정이 한 차례 연기되었으며, 추가적인 수정 작업이 진행되었을 가능성도 제기되고 있습니다.</p>'
    },
    {
      type: 'h2',
      id: 'section5',
    ...
    {
      type: 'body',
      html: '<p>봉 감독은 지난 인터뷰에서 <b>&quot;이 작품은 인간 존재의 본질과 우주 개척이라는 거대한 주제를 다룬다. 관객들이 스스로 질문하고 답을 찾을 수 있도록 설계된 영화다.&quot;</b>라고 밝히며 작품에 대한 자신감을 드러냈습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>로버트 패틴슨도 한 인터뷰에서 <b>&quot;</b><b>이 작품은 독창적이고 도전적인 시나리오를 가지고 있다. 봉 감독과의 협업은 내 경력에서 가장 특별한 경험 중 하나였다.&quot;</b>라고 언급하며 작품에 대한 기대감을 높였습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>기생충 이후로 또 한 번의 대작이 탄생하기를 바라는 바입니다.</p>'
    },
    {
      type: 'h2',
      id: 'section7',
