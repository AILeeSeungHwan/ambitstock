const post = {
  ...
  sections: [
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start; font-size: 16px;&quot;>평범한 가장 만수(이병헌)는 갑작스러운 실직으로 인해 삶의 균형을 잃게 된다.</p>'
    },
    { type: 'image', src: '/images/post85_img1.webp', alt: '어쩔수가없다 개봉 평론가 후기', caption: 'ⓒ R의 필름공장' },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start; font-size: 16px;&quot;>그는 가족을 지켜내려는 본능과 사회적 기대 사이에서 점점 무너져가며, 예상치 못한 폭력적 선택의 길로 들어선다. <i>어쩔 수 없다</i>는 “일과 남성성, 그리고 가족의 의미”라는 질문을 유머와 블랙코미디, 서스펜스적 요소로 풀어낸다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<ul style=&quot;color: inherit; font-size: 16px; line-height: 1.6;&quot;> <li><b>감독</b>: 박찬욱 (Chan-wook Park)</li> <li><b>주연</b>: 이병헌 손예진</li> <li><b>출연</b>: 박희순 이성민 엄혜란 차승원 유연석 윤가이</li> </ul>'
    },
    { type: 'image', src: '/images/post85_img2.jpg', alt: '어쩔수가없다 개봉 평론가 후기', caption: 'ⓒ R의 필름공장' },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>영화 어쩔수가없다 로튼토마토 해외 평론가 후기를 알아보도록 하겠습니다.</b></p>'
    },
    { type: 'image', src: '/images/post85_img8.jpg', alt: '어쩔수가없다 개봉 평론가 후기', caption: 'ⓒ R의 필름공장' },
    { type: 'image', src: '/images/post85_img7.jpg', alt: '어쩔수가없다 개봉 평론가 후기', caption: 'ⓒ R의 필름공장' },
    { type: 'image', src: '/images/post85_img6.jpg', alt: '어쩔수가없다 개봉 평론가 후기', caption: 'ⓒ R의 필름공장' },
    { type: 'image', src: '/images/post85_img5.jpg', alt: '어쩔수가없다 개봉 평론가 후기', caption: 'ⓒ R의 필름공장' },
    { type: 'image', src: '/images/post85_img4.jpg', alt: '어쩔수가없다 개봉 평론가 후기', caption: 'ⓒ R의 필름공장' },
    { type: 'image', src: '/images/post85_img3.jpg', alt: '어쩔수가없다 개봉 평론가 후기', caption: 'ⓒ R의 필름공장' },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Mattie Lucas - 평점 3/4</b><br>팬들은 이 사랑스러운 곰과 그의 가족과 함께하는 두 시간을 분명히 즐길 것이다.</br></p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;>다만 이번 모험은 이전 작품들이 보여준 높은 완성도에는 미치지 못하였다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Nicolas Rapold (Sight &amp; Sound, TOP CRITIC)</b><br/>“<i>어쩔 수 없다</i>는 이미 <i>헤어질 결심</i>에 필적할 평가를 얻고 있으며, 인간 경제학이 폭주하는 시대에 더욱 설득력 있는 이야기로 다가온다.” (2025-09-04)</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Hoai-Tran Bui (Inverse)</b><br/>“박찬욱의 가장 유쾌한 영화이자 풍자극으로, 가진 자들이 모든 것을 잃어버릴 수 있는 허망함과 그것을 지키기 위해 발버둥치는 절박함을 경쾌하게 풀어낸다.” (2025-09-04)</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Hannah Strong (Little White Lies, TOP CRITIC)</b><br/>“비극과 희극 사이의 긴장을 완벽히 표현해낸 이병헌의 연기는 마스터클래스라 할 만하다.” (2025-09-01)</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Stefania Sarrubba (The Skinny)</b><br/>“남성들이 가장의 역할에 매달리다 무너져가는 과정을 탐구한다. 만수의 도덕적 추락을 우아하게 그려내며, 결말은 여성들에게 맡겨진다.” (평점: 4/5 | 2025-09-01)</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Serena Seghedoni (Loud and Clear Reviews)</b><br/>“이병헌은 최고의 연기를 선보이며, 인류애의 상실을 경고하는 블랙 코미디 스릴러를 완성한다.” (평점: 4/5 | 2025-08-31)</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>James Mottram (Radio Times)</b><br/>“박찬욱 영화 중 가장 넓고 덜 미묘하지만 여전히 활기찬 여정을 선사한다.” (평점: 3/5 | 2025-08-30)</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>David Rooney (The Hollywood Reporter, TOP CRITIC)</b><br/>“완벽하진 않지만, ‘부족한 박찬욱 영화’조차 다른 감독들의 최고작보다 뛰어나다.” (2025-08-30)</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>John Bleasdale (Time Out, TOP CRITIC)</b><br/>“짜장면보다 더 까만 유머로 빚어진 이 영화는 박찬욱의 마스터피스일지도 모른다.” (평점: 5/5 | 2025-08-30)</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Adam Solomons (AwardsWatch)</b><br/>“전형적인 한국적 정서가 담겼다. 가족 해체에 대한 불안, 미국 패권에 대한 회의, 분단과 전쟁의 상처까지.” (평점: B+ | 2025-08-29)</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Martin Tsai (Critic\'s Notebook)</b><br/>“코스타 가브라스와 달리 박찬욱은 주인공을 더 노동자 계급적으로 묘사했다. ‘오징어 게임’의 악역으로 뛰어난 이병헌을 택한 것도 탁월하다.” (2025-08-29)</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Dallas King (Flick Feast)</b><br/>“유머러스하면서도 따뜻하고 동시에 섬뜩하다. 박찬욱의 신작은 보지 않고는 못 배길 작품.” (평점: 4/5 | 2025-08-29)</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Nicholas Bell (IONCINEMA.com)</b><br/>“AI에 의존하는 취업 시장 속에서 위험한 환상을 좇는 주인공을 그린 네오 누아르. 박찬욱의 노련한 이야기 전개가 돋보인다.” (평점: 4/5 | 2025-08-29)</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Steve Pond (TheWrap, TOP CRITIC)</b><br/>“봉준호의 <i>기생충</i>만큼 사회 풍자와 폭력을 절묘하게 섞진 못했지만, 여전히 충분히 강렬하다.” (2025-08-29)</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;color: inherit; text-align: start;&quot;><b>Damon Wise (Deadline Hollywood Daily)</b><br/>“<i>어쩔 수 없다</i>는 봉준호의 <i>기생충</i>에 대한 박찬욱의 응답처럼 느껴지는 작품.</p>'
    },
    {
      type: 'body',
