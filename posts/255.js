const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '더러운 돈에 손대지 마라 — 줄거리와 주요 갈등', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: '시체스 영화제 평론가 긍정 반응', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
    ...
    { type: 'h2', id: 'section3', text: '시체스 영화제 평론가 부정 반응 — 단점도 확인하자', gradientStyle: 'linear-gradient(to right, #6a1b9a, #ab47bc)' },
