const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '빅토리 시사회 긍정 반응 — 써니 재질의 Y2K 청춘 감성', gradientStyle: 'linear-gradient(to right, #6a1b9a, #ab47bc)' },
    ...
    { type: 'h2', id: 'section2', text: '빅토리 시사회 아쉬운 반응 — 바쁜 전개와 호불호 요소', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
