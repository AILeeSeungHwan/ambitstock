const post = {
  ...
  sections: [
    {
      type: 'cta',
      href: 'https://search.daum.net/search?w=tot&DA=YZR&t__nil_searchbox=btn&sug=&sugo=&sq=&o=&q=%EA%B3%A0%EB%A0%A4%EA%B1%B0%EB%9E%80%EC%A0%84%EC%9F%81+%EC%9E%AC%EB%B0%A9%EC%86%A1',
      text: '고려거란전쟁 재방송 – Daum 검색'
    },
    {
      type: 'intro',
    ...
    {
      type: 'image',
      src: '/images/post470_thumb.svg',
      alt: '[고려거란전쟁 중국 반응 및 해외 평점 시청률 몇부작 종영일] 몰래보는 중국의 비아냥? - 넷플릭스 현재 상영작 재방송 다시보기 편성표 정보',
      caption: '[고려거란전쟁 중국 반응 및 해외 평점 시청률 몇부작 종영일] 몰래보는 중국의 비아냥? - 넷플릭스 현재 상영작 재방송 다시보기 편성표 정보'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p><figure class=&quot;imageblock widthContent&quot; data-origin-height=&quot;431&quot; data-origin-width=&quot;715&quot;><span data-alt=&quot;mydramalist 고려거란전쟁 평점&quot; data-phocus=&quot;https://blog.kakaocdn.net/dna/kK0SD/btsCP21lkAH/AAAAAAAAAAAAAAAAAAAAADfnPOe7RHMEeGoah6gnGT2_j7yWYOr2WVGvkxYVv1z_/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=a7%2FsDNh%2B4vJKhxuQMC604ysAIY0%3D&quot; data-url=&quot;https://blog.kakaocdn.net/dna/kK0SD/btsCP21lkAH/AAAAAAAAAAAAAAAAAAAAADfnPOe7RHMEeGoah6gnGT2_j7yWYOr2WVGvkxYVv1z_/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=a7%2FsDNh%2B4vJKhxuQMC604ysAIY0%3D&quot;></span><figcaption>mydramalist 고려거란전쟁 평점</figcaption> </figure> </p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><figure class=&quot;imageblock alignCenter&quot; data-filename=&quot;IMDB.JPG&quot; data-origin-height=&quot;346&quot; data-origin-width=&quot;1252&quot;><span data-alt=&quot;IMDB 드라마 고려거란전쟁 평점&quot; data-phocus=&quot;https://blog.kakaocdn.net/dna/rGjC8/btsCODOjmzT/AAAAAAAAAAAAAAAAAAAAALxKCtYWV44S_1fX-oiZ2_DcIGrD9DbGf0AJScokUg94/img.jpg?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=KcE9FHSxoVLPYCf0EiHF7m7nEYQ%3D&quot; data-url=&quot;https://blog.kakaocdn.net/dna/rGjC8/btsCODOjmzT/AAAAAAAAAAAAAAAAAAAAALxKCtYWV44S_1fX-oiZ2_DcIGrD9DbGf0AJScokUg94/img.jpg?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=KcE9FHSxoVLPYCf0EiHF7m7nEYQ%3D&quot;></span><figcaption>IMDB 드라마 고려거란전쟁 평점</figcaption> </figure> </p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>정상적인 루트에서는 시청하지 못하는 중국의 고려거란전쟁에 대한 네티즌들 리뷰입니다. </p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;color: #f3c000;&quot;><b>(좋아요 866)</b></span></i></p>'
    },
    {
      type: 'body',
      html: '<p><i>(한국은) 현실에서는 이긴 적 없고, 영화와 드라마에서는 진 적이 없지 </i></p>'
    },
    {
      type: 'body',
      html: '<p><i><i><span style=&quot;color: #f3c000;&quot;><b>(좋아요 252)</b></span></i><span> </span></i></p>'
    },
    {
      type: 'body',
      html: '<p><i>내 기억이 잘못된게 아니라면, 고구려는 한국과 아무런 관계가 없는데 오직 한국인들만 고구려의 후예라고 믿음 </i></p>'
    },
    {
      type: 'body',
      html: '<p><i> <i><b><span style=&quot;color: #f3c000;&quot;>(좋아요 3)</span></b></i> </i></p>'
    },
    {
      type: 'body',
      html: '<p><i>고려는 둥베이 사람들이고 한국과는 관계가 없어 </i></p>'
    },
    {
      type: 'body',
      html: '<p><i>단순한 학술적 관점에서 토론하자면, 어느 역사서에 기록된 내용임?</i></p>'
    },
    {
      type: 'body',
      html: '<p><i><i><b><span style=&quot;color: #f3c000;&quot;>(좋아요 4)</span></b></i></i></p>'
    },
    {
      type: 'body',
      html: '<p><i>한국 자체가 고조선의 후예 부여인이 세운 나라임!</i></p>'
    },
    {
      type: 'body',
      html: '<p><i>1. 고구려 주몽 부여인</i></p>'
    },
    {
      type: 'body',
      html: '<p><i>2. 백제 시조 주몽의 아들도 부여인</i></p>'
    },
    {
      type: 'body',
      html: '<p><i>3. 신라 시조 박혁거세 부여인</i></p>'
    },
    {
      type: 'body',
      html: '<p><i>조선반도는 인류 최초의 땅이 아니라 고대 동북아민족이 이만한 땅임 </i></p>'
    },
    {
      type: 'body',
      html: '<p><i>삼한 = 고대 삼조선 = 고구려, 백제, 신라 </i></p>'
    },
    {
      type: 'body',
      html: '<p><i>남을 존중하는 것은 자신을 존중하는 것임 한국의 흑역사는 즉, 조선의 흑역사. 득보다 실이 많음 </i></p>'
    },
    {
      type: 'body',
      html: '<p><i>위 댓글에 대한 답글</i></p>'
    },
    {
      type: 'body',
      html: '<p><i>넌 또 뭘 훔치려는 거임? 우리 복희를 훔치고 우리 봉황을 훔치고, 넌 아직도 뭘 훔치려는 거냐? 위대한 역사가 없는 민족과 국가는 꼭 딴 나라의 역사, 문화, 신화등을 훔치려 들지 </i></p>'
    },
    {
      type: 'body',
      html: '<p><i>( 참고: 복희는 중국 고대의 전설상의 제왕 또는 신으로 3황5제 중 중국 최고의 제왕으로 친다고 함)</i></p>'
    },
    {
      type: 'body',
      html: '<p><i><u><span style=&quot;color: #ef6f53;&quot;>(한국 옹호 답글인줄 알았으나 그 반대였네요)</span></u></i></p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;color: #f3c000;&quot;><b><i>(좋아요 34)</i> </b></span></p>'
    },
    {
      type: 'body',
      html: '<p><i>조복, 투구와 갑옷을 중국을 베끼다니, 정말 염치가 없구만 </i></p>'
    },
    {
      type: 'body',
      html: '<p><i>헛소리 지껄이지 마라, 현대 한국인의 조상은 마한임. 고구려는 부여인이지 한국인의 조상이 아님 </i></p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;color: #f3c000;&quot;><b>(좋아요 10)</b></span></i></p>'
    },
    {
      type: 'body',
      html: '<p><i>나도 궁금하네. 요, 금, 몽원 모두 그렇게 쩔었는데 어째서 아무도 이 반도국가를 멸망시키지 못한거임? 이후에 청나라도 이 나라를 굴복시켰을 뿐, 오히려 남쪽의 어려운 중원을 상대했잖아 죽기 살기로 말이야.</i></p>'
    },
    {
      type: 'body',
      html: '<p><b><span style=&quot;color: #f3c000;&quot;> <i>(좋아요 50)</i> </span></b></p>'
    },
    {
      type: 'body',
      html: '<p><i>일본 식민지 시기에 찍은 사진은, 조선 도처에 초가집이 있고 귀족의 거처에만 기와집이 있어. 게다가 작은 기와집임. </i></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>고려거란전쟁 재방송 다시보기 편성표는 아래링크를 통하여 확인 가능합니다.</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: center;&quot;>고려거란전쟁 재방송 다시보기 편성표</p>'
    },
    {
      type: 'body',
      html: '<p style=&quot;text-align: left;&quot;>이상으로 드라마 고려거란전쟁 포스팅 마칩니다.</p>'
    },
    {
      type: 'body',
