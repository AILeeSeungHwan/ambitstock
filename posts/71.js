const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: '<p>2025년 9월, 영국 다큐멘터리 드라마 <b>마이다스 맨: 전설의 시작 (Midas Man)</b>이 개봉합니다.</p><p>이 작품은 비틀즈의 전설을 세상에 알린 매니저 <b>브라이언 엡스타인</b>의 삶을 다룬 전기 영화로, <b>제이콥 포춘-로이드</b>가 주연을 맡아 관심을 모으고 있습니다. 비틀즈의 탄생 뒤편에 숨어 있던 ‘다섯 번째 비틀즈’라 불린 인물의 이야기를 조명하며, 화려함 뒤에 가려진 개인적 고뇌까지 담아낸 작품입니다.</p><p>이번 글에서는 <b>해외 평론가 평가</b>와 <b>관객 관람평</b>을 모아 정리했습니다.</p><p>음악사에 한 획을 그은 비틀즈의 숨은 주역을 다룬 영화가 어떤 반응을 받고 있는지 함께 살펴보겠습니다.</p><p><figure class=&quot;imageblock widthContent&quot; data-origin-height=&quot;460&quot; data-origin-width=&quot;613&quot;><span data-alt=&quot;영화 마이다스 맨: 전설의 시작&quot; data-phocus=&quot;https://blog.kakaocdn.net/dna/wWVxj/btsQHAiQYFf/AAAAAAAAAAAAAAAAAAAAAHMUFsZvnWY973cSUYKRmkvq_hV0B0CUvM_PWc7q1G58/img.jpg?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=gm4%2FGlWTD5VmTo%2BiT9LhL3PsgdM%3D&quot; data-url=&quot;https://blog.kakaocdn.net/dna/wWVxj/btsQHAiQYFf/AAAAAAAAAAAAAAAAAAAAAHMUFsZvnWY973cSUYKRmkvq_hV0B0CUvM_PWc7q1G58/img.jpg?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&amp;expires=1774969199&amp;allow_ip=&amp;allow_referer=&amp;signature=gm4%2FGlWTD5VmTo%2BiT9LhL3PsgdM%3D&quot;></span><figcaption>영화 마이다스 맨: 전설의 시작</figcaption> </figure> </p>'
    },
    {
      type: 'image',
      src: '/images/post71_thumb.svg',
      alt: '영화 마이다스 맨: 전설의 시작 관람평 출연진 | 비틀즈 매니저 브라이언 엡스타인 이야기',
      caption: '영화 마이다스 맨: 전설의 시작 관람평 출연진 | 비틀즈 매니저 브라이언 엡스타인 이야기'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<ul style=&quot;list-style-type: disc;&quot;> <li><b>Owen Gleiberman (Variety)</b> — “엡스타인의 진솔하고 감동적인 면을 포착” (긍정적).</li> <li><b>Gary M. Kramer (Philadelphia Gay News)</b> — “제이콥 포춘-로이드의 연기가 카리스마 넘쳤다. 즐거운 초상화” (호평).</li> </ul>'
    },
    {
      type: 'h2',
      id: 'section3',
      text: '마이다스 맨: 전설의 시작 관객 관람평',
    ...
    {
      type: 'body',
      html: '<ul style=&quot;list-style-type: disc;&quot;> <li><b>Jill</b> — “이 영화는 훌륭했다(EXCELLENT).”</li> <li><b>Thomas S</b> — “엡스타인과 비틀즈를 다룬 영화 중 가장 진짜 같았다. 음악도 훌륭.”</li> </ul>'
    },
    {
      type: 'body',
      html: '<p>관객들의 평가는 대체로 <b>제이콥 포춘-로이드의 연기와 영화의 진정성</b>을 높이 샀습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>다만 <b>음악 사용의 제한</b>과 <b>심층적인 묘사 부족</b>은 아쉬움으로 남았습니다.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section4',
      text: '마이다스 맨: 전설의 시작 총평',
    ...
    {
      type: 'body',
      html: '<p>로튼 토마토 평점은 평론가 83%, 관객 77%로 준수한 결과를 보여주고 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>특히 비틀즈 팬이라면, 음악적 배경과 함께 <b>비틀즈의 탄생 뒤 숨겨진 이야기</b>를 확인할 수 있어 추천할 만한 작품입니다.</p>'
    },
    {
      type: 'body',
      html: '<p>다만 음악의 사용이 제한적이라는 점은 염두에 두는 것이 좋습니다.</p>'
    },
    {
      type: 'h2',
      id: 'section5',
