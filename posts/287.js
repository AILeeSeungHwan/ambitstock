const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>2024년 9월 전 세계, 글로벌 인기 순위 1위 넷플릭스 시리즈, 완전무결한 커플 ( 영어제목 : The Perfect Couple )입니다.</b></span></p><p>한국 넷플릭스 순위에서도 상위권을 유지하고 있는 시리즈인 완전무결한 커플의 해외 평론가, 관람객 평점을 확인해 보도록 하겠습니다.</p><p><span style=&quot;background-color: #9feec3;&quot;><b>먼저 로튼 토마토 완전무결한 커플 평론가 평점과 관람객 평점 알아보겠습니다.</b></span></p>'
    },
    {
      type: 'image',
      src: '/images/post287_thumb.svg',
      alt: '넷플릭스 시리즈 완전무결한 커플 글로벌 순위 압도적 1위 | 로튼 평점 볼만할까?',
      caption: '넷플릭스 시리즈 완전무결한 커플 글로벌 순위 압도적 1위 | 로튼 평점 볼만할까?'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>평론가 평점 63%, 관람객 평점 67%의 완전무결한 커플 평점입니다.</b></span></p>'
    },
    {
      type: 'body',
      html: '<p>글로벌 인기 순위 1위에 비해 낮은 평점을 기록하고 있지만, 최근 넷플릭스 작품들의 평점에 비하면 그래도 선방한 평점을 기록하고 있습니다. 최근 공개된 넷플릭스 작품들의 모든 정보는 아래 포스팅에서 확인 가능합니다.</p>'
    },
    {
      type: 'body',
      html: '<p class=&quot;og-title&quot;>넷플릭스 영화 추천 2024년 9월 인기 작품 순위 TOP 10 총정리!</p>'
    },
    {
      type: 'body',
      html: '<p class=&quot;og-desc&quot;>2024년 9월 기준 넷플릭스 볼만한 영화를 인기 순위 기준으로 추천해드립니다. 모든 작품들에 대한 정보는 로튼 토마토와 IMDB 평점과 후기를 바탕으로 순위를 측정하였으며, 각 영화에 대한 평론</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>다음으로 IMDB 평점 알아보겠습니다.</b></span></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>IMDB에서도 로튼토마토와 마찬가지로 평점 6.6점</b></span>의 낮은 점수를 기록하고 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>평점 표본은 무려 2만 5천 개 이상으로, 인기 순위 1위 작품인 만큼 많은 표본을 모았습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>표본 분포를 살펴보면 7점에 가장 많은 평점이 부여되었으며, 전체적으로 중간 평점에 수렴한 것을 알 수 있습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>10점의 비중은 많지가 않네요.</p>'
    },
    {
      type: 'body',
      html: '<p>국가 분포는 미국, 영국, 캐나다, 터키, 스웨덴 순으로 평점을 남겼습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>에피소드 별 평점은 6.9점으로 수렴하며, 3편에서만 7.2점을 기록</b></span>하였습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>만약 시청 예정이시라면, 해당 평점을 참고하여 큰 기대는 하지 않기를 바랍니다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>완전무결한 커플 출연진 등장인물입니다.</b></span></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>니콜 키드먼, 다코타 패닝, 이샨 카타르 등 유명 할리우드 배우들이 출연합니다.</p>'
    },
    {
      type: 'body',
      html: '<p>개인적으로 다코타 패닝을 좋아하지만 이번 작품에서의 매력은 크게 느끼지 못하였습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>주요 출연진과 작품 내 역할은 다음과 같습니다.</p>'
    },
    {
      type: 'body',
      html: '<p>- <b>니콜 키드먼</b>: 그리어 개리슨 윈 버리 역 (신랑의 어머니)</p>'
    },
    {
      type: 'body',
      html: '<p>- <b>리에브 슈라이버</b>: 태그 윈버리 역 (신랑의 아버지)</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>- <b>이브 휴슨</b>: 아멜리아 색스 역 (신부)</p>'
    },
    {
      type: 'body',
      html: '<p>- <b>빌리 하울</b>: 벤지 윈버리 역 (신랑)</p>'
    },
    {
      type: 'body',
      html: '<p>- <b>다코타 패닝</b>: 아비 윈 버리 역 (토마스 윈버리 부인)</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>- <b>잭 레이너</b>: 토머스 윈버리 역 (신랑의 형제)</p>'
    },
    {
      type: 'body',
      html: '<p>- <b>메건 페이히</b>: 메릿 모나코 역 (신부의 절친)</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>- <b>샘 니볼라</b>: 윌 윈버리 역 (신랑의 형제)</p>'
    },
    {
      type: 'body',
      html: '<p>- <b>미아 아이작</b>: 클로이 키티 역 (서장의 딸)</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>결혼식 전날 살인 사건이 벌어지며, 등장인물들 간의 관계와 비밀들이 드러나기 시작합니다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>특히 아멜리아와 그녀의 들러리 메릿, 그리고 윈버리 가문의 구성원들 사이의 갈등과 사건의 미스터리가 중심</b></span>입니다.</p>'
    },
    {
      type: 'body',
      html: '<p>이상으로 넷플릭스 시리즈 완전무결한 커플 포스팅 마칩니다.</p>'
    },
    {
      type: 'body',
