const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post208_thumb.svg',
      alt: '글래디에이터 2 (Gladiator) 영화 예매 순위 1위! 줄거리 내용과 해외 평론가 후기',
      caption: '글래디에이터 2 (Gladiator) 영화 예매 순위 1위! 줄거리 내용과 해외 평론가 후기'
    },
    { type: 'toc' },
    ...
    },
    {
      type: 'h2',
      id: 'section2',
      text: '새로운 영웅, 루시우스의 여정',
      gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)'
    },
    {
      type: 'body',
      html: '<p><i>글래디에이터 Ⅱ</i>는 막시무스의 죽음 이후 약 20여 년이 흐른 고대 로마를 배경으로 한다. 로마는 두 폭군 황제, 게타와 카라칼라가 지배하며 자유의 꿈이 사라진 시대를 맞이한다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>이 영화의 주인공은 바로 막시무스의 아들인 루시우스(폴 메스칼)이다. </b></span></p>'
    },
    {
      type: 'body',
      html: '<p>어린 시절, 루시우스는 정치적 혼란을 피해 어머니의 뜻에 따라 로마가 아닌 누미디아에서 자라게 된다.</p>'
    },
    {
      type: 'body',
      html: '<p>그러나 성인이 된 후, 루시우스는 전쟁 중 아내와 동료를 잃고 전쟁 포로가 되어 로마로 끌려온다. 그는 로마군의 장군인 아카시우스(페드로 파스칼 분)에 의해 검투사로 발탁된다.</p>'
    },
    {
      type: 'h2',
      id: 'section3',
      text: '검투사로서의 싸움과 출생의 비밀',
      gradientStyle: 'linear-gradient(to right, #6a1b9a, #ab47bc)'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>루시우스는 콜로세움에 입성해 잔혹한 결투를 치르며, 자신이 막시무스의 아들임을 알게 된다. </b></span></p>'
    },
    {
      type: 'body',
      html: '<p>이는 단순한 전투의 연대기를 넘어서, 루시우스가 자신의 정체성을 찾아가는 과정이자 로마의 새로운 영웅으로 거듭나는 여정을 그린다.</p>'
    },
    {
      type: 'body',
      html: '<p>영화는 루시우스의 내면적 갈등과 고뇌, 그리고 그가 과거의 영웅인 막시무스를 계승하려는 노력과 희생을 중심으로 전개된다. 막시무스의 정신을 이어받아, 루시우스는 자유와 정의를 위해 싸우며 새로운 시대를 여는 영웅으로 성장한다.</p>'
    },
    {
      type: 'body',
    ...
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section4',
      text: '웅장한 스케일과 강렬한 액션',
      gradientStyle: 'linear-gradient(to right, #e53935, #ef5350)'
    },
    {
      type: 'body',
      html: '<p>리들리 스콧 감독은 <i>글래디에이터 Ⅱ</i>에서 고대 로마의 웅장함과 콜로세움의 대규모 전투를 사실감 넘치게 재현했다. 전편이 남긴 장대한 스케일을 그대로 이어받아, 영화는 강렬한 액션과 치열한 전투 장면들로 관객을 몰입시킨다.</p>'
    },
    {
      type: 'body',
      html: '<p>특히 루시우스가 검투사로서 펼치는 결투는 단순한 싸움의 차원을 넘어서, 로마 제국의 운명을 건 중요한 싸움으로 변모한다. 이 싸움에서 루시우스는 단순히 싸움의 승리자가 아니라, 로마의 자유를 위한 결단의 주체로서 서게 된다.</p>'
    },
    {
      type: 'h2',
      id: 'section5',
      text: '폴 메스칼의 강렬한 연기와 루시우스의 내면',
      gradientStyle: 'linear-gradient(to right, #00897b, #26a69a)'
    },
    {
      type: 'body',
      html: '<p>루시우스를 연기한 신예 배우 폴 메스칼은 그의 복잡한 내면을 섬세하게 그려내며 영화의 중심을 단단히 잡았다. 루시우스는 아버지 막시무스의 그림자 속에서 자신의 정체성을 찾아가고, 그 과정에서 겪는 갈등과 고뇌는 폴 메스칼의 뛰어난 연기력 덕분에 더욱 깊이 있게 전달된다.</p>'
    },
    {
      type: 'body',
      html: '<p>특히 콜로세움에서 펼쳐지는 액션 장면에서 그는 강렬하면서도 절제된 연기를 선보이며 관객을 완전히 몰입하게 만든다. 그의 내면의 변화와 싸움은 단순히 검투사의 삶을 넘어서, 자유와 정의를 위해 싸우는 영웅으로서의 여정을 묘사한다.</p>'
    },
    {
      type: 'body',
    ...
    },
    {
      type: 'h2',
      id: 'section6',
      text: '\'글래디에이터 Ⅱ\'의 전 세계적 반응',
      gradientStyle: 'linear-gradient(to right, #1a1a2e, #e94560)'
    },
    {
      type: 'body',
      html: '<p><i>글래디에이터 Ⅱ</i>는 개봉 첫날 박스오피스 1위를 기록하며 흥행의 신호탄을 쏘아 올렸다. 72,029명의 관객을 동원하며 경쟁작들을 압도적인 차이로 제친 이 영화는 개봉 첫날부터 관객들의 뜨거운 호평을 받았다.</p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>CGV 골든에그지수에서 94%라는 높은 점수를 기록</b></span>하며, 실관람객들의 만족도를 입증했다. <i>글래디에이터 Ⅱ</i>는 전 세계적으로도 큰 호응을 얻고 있다. &quot;리들리 스콧 감독이 원작에 필적할 만한 보기 드문 속편을 만들어냈다&quot;, &quot;거대하고 대담하며 믿기 힘든 경계를 넘나드는 \'글래디에이터 Ⅱ\'는 정말 대단하다&quot;는 해외의 찬사도 이어졌다.</p>'
    },
    {
      type: 'body',
      html: '<div><center><a href=&quot;https://ambitstock.com/entry/%EA%B8%80%EB%9E%98%EB%94%94%EC%97%90%EC%9D%B4%ED%84%B0-2-%ED%8F%89%EC%A0%90-%EA%B4%80%EB%9E%8C%ED%8F%89-%ED%9B%84%EA%B8%B0-%EC%A0%9C%EB%AA%A9-%EB%9C%BB-%EC%9D%98%EB%AF%B8-%EB%A1%9C%ED%8A%BC-%ED%86%A0%EB%A7%88%ED%86%A0-%ED%8F%89%EB%A1%A0%EA%B0%80-%EB%B0%98%EC%9D%91%EC%9D%80&quot; title=&quot;글래디에이터 2 보러가기&quot;><button class=&quot;primary&quot;>글래디에이터 2 반응 보러가기</button></a></center></div>'
    ...
    {
      type: 'body',
      html: '<p><i>글래디에이터 Ⅱ</i>는 단순히 전작의 명성에 의존하지 않고, 새롭고 신선한 이야기를 통해 로마 제국의 과거와 미래를 잇는 강렬한 서사를 풀어냈다. 루시우스라는 새로운 영웅의 등장과 함께, 영화는 폭압적 권력에 맞서는 자유와 정의의 가치를 다시 한 번 강조한다.</p>'
    },
    {
      type: 'ending',
      html: '<p>전쟁과 싸움, 그리고 내면의 갈등을 넘나드는 루시우스의 여정은 관객들에게 깊은 인상을 남기며, <i>글래디에이터</i>의 세계를 더욱 풍성하게 만들어낸다. 웅장한 스케일, 강력한 액션, 그리고 뛰어난 연기력으로 무장한 <i>글래디에이터 Ⅱ</i>는 전 세계 영화 팬들에게 또 하나의 전설적인 영화를 선사하며, 11월 극장가를 장악하고 있다.</p>'
    },
    { type: 'ad', slot: '6297515693', format: 'auto' },
  ]
}
