const post = {
  ...
  sections: [
    ...
    { type: 'h2', id: 'section1', text: '더러운 돈에 손대지 마라 주요 출연진', gradientStyle: 'linear-gradient(to right, #e50914, #ff6b6b)' },
    ...
    { type: 'h2', id: 'section2', text: '등장인물 관계와 줄거리 흐름', gradientStyle: 'linear-gradient(to right, #1a73e8, #42a5f5)' },
