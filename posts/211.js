const post = {
  ...
  sections: [
    ...
    { type: 'ad', slot: '6297515693', format: 'auto' },
    {
      type: 'h2',
      id: 'section1',
      text: '영화 비틀쥬스 비틀쥬스 로튼토마토 평론가 평점',
    ...
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Filipe Freitas - 평점 2.5/5</span></i><br>크레딧이 올라갈 때, 104분간 버튼 스타일의 익살스러운 세계에 빠진 듯한 기분이 들겠지만, 그만큼 보람은 크지 않다.</br></p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Vera Wylde - 평점 없음</span></i><br/>이 영화는 마치 첫 번째 초안 스크립트처럼 느껴지려 했으나, 사실 두세 개의 초안을 엮어 놓은 듯한 느낌을 준다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Meg Walter - 평점 없음</span></i><br/>이 영화는 결코 지나치게 무섭지는 않지만, 충분히 음산해서 앞으로 수년간 할로윈 미디어 목록에 남을 수 있을 만한 작품이다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Lee Zumpe - 평점 없음</span></i><br/>이 영화가 결국 효과를 거두는 이유는, 라이더, 오하라, 오르테가의 화면 속 가족 케미 덕분이다. 덕분에 복잡한 서브플롯에 빠지지 않는다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Josie Meléndez - 평점 6/10</span></i><br/>\'비틀쥬스 비틀쥬스\'는 오싹함과 스릴이 섞인 혼합된 작품이다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Yasser Medina - 평점 5/10</span></i><br/>이 속편은 버튼이 자신의 스타일을 회복해 엽기적인 캐릭터의 음산한 이미지를 확장하는 데 성공했지만, 공포와 코미디가 비어 있는 반복 속에 갇혀 아무런 놀라움도 남기지 않는다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Asia Frey - 평점 없음</span></i><br/>이 작품은 완전히 실현된, 자신감 넘치는 귀환이다. 감독 자신조차 모방할 수 없는 독특하고 마법적인 활력에 가득 차 있으며, 모든 엉뚱하고 눈을 휘둥그레지게 만드는 장면에서 그 진정성이 느껴진다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Matt Hudson - 평점 없음</span></i><br/>완벽하지는 않지만, 오리지널의 재미를 과도하게 향수에 의존하지 않고 잘 담아내었다. 키튼은 즐기고 있으며, \'최고의 유령\'과 다시 함께 시간을 보낼 수 있다는 것만으로도 기쁨이다.</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>John Serba - 평점 없음</span></i><br/>&quot;날짜를 말하네, 날짜를 말하네- 아니!&quot;</p>'
    },
    {
      type: 'body',
      html: '<p><i><span style=&quot;background-color: #f3c000;&quot;>Chris McCoy - 평점 없음</span></i><br/>\'비틀쥬스 비틀쥬스\'는 오리지널의 어두운 마법을 완벽하게 되살리지는 못했지만, 그만큼 즐겁기 때문에 신경 쓰지 않게 된다.</p>'
    },
    {
      type: 'body',
