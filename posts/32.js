const post = {
  id: 32,
  sections: [
    { type: 'intro', html: '<p>유튜브 댓글, 레딧, 트위터를 뒤지다 보면 한국 영화에 대한 외국인들의 반응이 흥미롭다. 특히 반전이 있는 영화를 보고 멘붕에 빠진 리액션 영상은 중독성이 있다. 나도 거의 매일 해외 반응 영상을 찾아보는데, 오늘은 외국인들이 충격받은 한국 영화 TOP 10을 모아봤다. 실제 댓글과 반응을 번역해서 정리했다.</p>' },
    ...
    { type: 'body', html: '<p>해외에서 &quot;Train to Busan&quot;은 한국 영화의 대명사 수준으로 자리 잡았다. 레딧에서 &quot;best zombie movie&quot; 글이 올라오면 부산행은 TOP 3 안에 든다. 가장 인상적인 외국인 댓글은 &quot;I went in expecting a generic zombie movie and came out emotionally destroyed&quot;(그냥 좀비 영화인 줄 알았는데 감정적으로 파괴당했다)였다. 마동석이 문을 막는 장면, 공유의 마지막 장면에서 리액션 영상 거의 전원이 운다. 넷플릭스를 통해 전 세계 190개국에 공개된 이후 해외 팬층이 크게 늘었고, 할리우드 리메이크 프로젝트도 진행 중이다. 로튼토마토 94% 신선도를 기록 중이며, 관객 점수도 89%로 높다.</p>' },
    { type: 'ad', slot: '6297515693', format: 'auto' },
    { type: 'h2', id: 'section3', text: '아가씨 (2016) - "비주얼이 예술이다"', gradientStyle: 'linear-gradient(to right, #c62828, #ef5350)' },
    { type: 'body', html: '<p>박찬욱 감독의 &quot;아가씨&quot;는 해외에서 시각적 아름다움과 스토리텔링 모두 높은 평가를 받는 작품이다. 레딧에서 자주 보이는 반응은 &quot;Every single frame could be a painting&quot;(모든 프레임이 그림이 될 수 있다)이다. 칸 영화제에서 기립 박수를 받았고, BBC가 선정한 21세기 최고의 영화 100편에도 이름을 올렸다. 사라 워터스의 원작 소설을 일제강점기 한국으로 옮긴 각색도 &quot;원작보다 낫다&quot;는 평가를 해외에서 많이 받았다. 로튼토마토 96% 신선도에 메타크리틱 84점이라는 좋은 점수를 기록 중이다. 유럽 영화 팬들 사이에서 &quot;아시아 영화의 정수&quot;라는 평가가 많다.</p>' },
    { type: 'h2', id: 'section4', text: '살인의 추억 (2003) - 봉준호의 숨겨진 걸작', gradientStyle: 'linear-gradient(to right, #e53935, #ff8a80)' },
    { type: 'body', html: '<p>기생충 이후 봉준호 감독의 과거작을 찾아본 외국인들이 가장 놀라는 작품이 바로 &quot;살인의 추억&quot;이다. &quot;How is this not more famous internationally?&quot;(이 영화가 왜 국제적으로 더 유명하지 않지?)라는 반응이 대다수다. 특히 마지막 장면에서 송강호가 카메라를 바라보는 눈빛에 대해 &quot;The most haunting final shot in cinema history&quot;(영화 역사상 가장 인상적인 마지막 장면)라는 평가가 반복적으로 등장한다. 실제 화성 연쇄 살인 사건의 범인이 2019년에 밝혀지면서 해외에서도 다시 화제가 됐고, 레딧에서 관련 글이 수만 개의 업보트를 받았다. 로튼토마토 95%를 기록 중이다.</p>' },
    ...
    { type: 'body', html: '<p>나홍진 감독의 &quot;곡성&quot;은 해외 호러 팬들 사이에서 꾸준히 언급되는 작품이다. 레딧 r/horror에서 &quot;best horror movie of the decade&quot; 글이 올라오면 곡성이 항상 언급된다. 가장 재밌는 외국인 반응은 &quot;I&apos;ve watched it 5 times and I still don&apos;t fully understand it, but that&apos;s what makes it a masterpiece&quot;(5번 봤는데 아직도 완전히 이해 못 하겠지만 그게 걸작인 이유다)였다. 국제 비평가들로부터 로튼토마토 99%라는 높은 점수를 받았고, 이는 한국 영화 역대 최고 수준이다. 굿 장면에서 외국인들의 리액션이 인상적인데, 문화적 맥락을 모르는 상태에서도 그 공포감을 체감한다는 점이 눈에 띈다.</p>' },
    ...
    { type: 'ending', html: '<p>한국 영화에 대한 해외 반응을 보면서 느끼는 건, 우리가 당연하게 여기는 작품들이 외국인에게는 &quot;인생 영화&quot;가 된다는 거다. 봉준호 감독이 아카데미에서 말한 &quot;1인치의 자막 장벽&quot;이 허물어지고 있다는 게 실감난다. 앞으로도 해외 반응 모음은 계속 업데이트할 예정이니 관심 있으면 북마크해두면 좋다.</p>' },
    { type: 'ad', slot: '6297515693', format: 'auto' },
  ]
}
module.exports = post
