const post = {
  ...
  sections: [
    ...
    {
      type: 'image',
      src: '/images/post58_thumb.svg',
      alt: '화이트 아웃(Whiteout) 관람평 액션·스릴러 영화｜정보·줄거리·평론가/관객 후기 총정리',
      caption: '화이트 아웃(Whiteout) 관람평 액션·스릴러 영화｜정보·줄거리·평론가/관객 후기 총정리'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p><b>화이트 아웃</b>은 인디 예산으로 <b>설원 서바이벌의 몰입감</b>을 꽤 똑똑하게 뽑아낸 작품이에요. <b>액션·스릴러의 기본기</b>는 탄탄하고, <b>인간 심리</b>를 밀어붙이는 구성이 매력적입니다. 다만 조명·템포 이슈로 몰입이 끊기는 구간이 있어 호불호가 생겨요. <b>설원 생존물·러프한 액션·장르 비틀기</b>를 좋아한다면 추천입니다.</p>'
    },
    {
      type: 'h2',
      id: 'section7',
