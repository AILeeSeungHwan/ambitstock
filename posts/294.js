const post = {
  ...
  sections: [
    {
      type: 'intro',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>2024년 9월 기준 넷플릭스 볼만한 영화를 인기 순위 기준으로 추천해드립니다.</b></span></p><p>모든 작품들에 대한 정보는 로튼 토마토와 IMDB 평점과 후기를 바탕으로 순위를 측정하였으며, 각 영화에 대한 평론가들의 후기 또한 준비하였습니다. 한국 작품부터, 해외 할리우드 작품까지, 종합적으로 순위를 측정하였습니다.</p><p>이외 원하시는 작품에 대한 후기와 평점 정보는 댓글을 통해서 요청해주세요.</p>'
    },
    {
      type: 'image',
      src: '/images/post294_thumb.svg',
      alt: '넷플릭스 영화 추천 2024년 9월 인기 작품 순위 TOP 10 총정리!',
      caption: '넷플릭스 영화 추천 2024년 9월 인기 작품 순위 TOP 10 총정리!'
    },
    { type: 'toc' },
    ...
    {
      type: 'body',
      html: '<p>상당히 낮은 점수의 딜리버런스, 또 다른 영화 더 유니온과 비슷한 평점을 기록하였습니다.</p>'
    },
    {
      type: 'body',
      html: '<p><b>8위는 영화 더 유니온 입니다.</b></p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>지금까지 알아본 순위는 40점 아래의 작품들이 즐비합니다. 최근 넷플릭스 영화들의 성적이 좋지못한 것을 알 수 있습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>황정민 염정아 주연 영화로 좋은 작품이 나오길 기대하였지만, 그저 그런 평범한 결과물이 나왔습니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p>최근 넷플릭스 오리지널 시리즈들의 성과가 좋지 못하였는데, 애니메이션과 예능, 다큐에서의 약진이 두드러집니다.</p>'
    },
    {
      type: 'body',
      html: '<p>앞서 살펴본 작품들의 평점을 보면 알겠지만, 넷플릭스 작품들의 로튼토마토 평점이 최악을 이어가는 와중, 그나마 잘 뽑힌 작품입니다.</p>'
    },
    {
      type: 'body',
    ...
    {
      type: 'body',
      html: '<p><b>1위는 레블리지입니다.</b></p>'
    },
    {
      type: 'body',
      html: '<p><span style=&quot;background-color: #9feec3;&quot;><b>평론가 평점 95%, 관람객 평점 79%의 레블리<span style=&quot;background-color: #9feec3;&quot;>지</span>입니다.</b></span></p>'
    },
    {
      type: 'body',
